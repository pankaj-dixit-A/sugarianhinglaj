...
public class clsGV
{
    ...
    public static string Website = "shrihinglaj.ddns.net:8080";
    //API Varible
    public static string msgAPI = "http://sms-latasoftware.com/api/sms.php?uid=484954455348&pin=52de608e42b5e&sender=HITESH&route=5&tempid=1&";
