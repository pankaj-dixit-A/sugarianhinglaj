    ...
    public void SugarPurchaseGledgerEffectForGST(string Tran_Type, int Doc_No, int Company_Code, int Year_Code)
    {
        try
        {
            ...
            if (MyDs.Tables[0].Rows.Count > 0)
            {
                ...
                double TCS_Amt = Convert.ToDouble(MyDs.Tables[0].Rows[0]["TCS_Amt"].ToString());
                string TCSNarration = "TCS " + PartyShort + " " + MyDoc_No;
                int Purchase_TCS_Account = Convert.ToInt32(System.Web.HttpContext.Current.Session["PurchaseTCSAc"].ToString());

                double TDS_Amt = Convert.ToDouble(MyDs.Tables[0].Rows[0]["TDS_Amt"].ToString());
                string TDSNarration = "TDS " + PartyShort + " " + MyDoc_No;
                int Purchase_TDS_Account = Convert.ToInt32(System.Web.HttpContext.Current.Session["PurchaseTDSAc"].ToString());
                ...
                ds = clsDAL.SimpleQuery("Delete from " + tblPrefix + "GLEDGER where TRAN_TYPE='" + Tran_Type + "' and DOC_NO='" + MyDoc_No
                ...
                using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
                {
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + MyDrCrHead + "',UNIT_CODE='" + Unit_Code + "',NARRATION='" + TCSNarration + "',AMOUNT='" + TCS_Amt + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + MyDrCrHead + "','" + Unit_Code + "','" + TCSNarration + "','" + TCS_Amt + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + Purchase_TCS_Account + "',UNIT_CODE='" + Unit_Code + "',NARRATION='" + TCSNarration + "',AMOUNT='" + TCS_Amt + "',DRCR='D',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + Purchase_TCS_Account + "','" + Unit_Code + "','" + TCSNarration + "','" + TCS_Amt + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','D','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    if (TDS_Amt != 0)
                    {
                        ...
                        obj.tableName = tblPrefix + "GLEDGER";
                        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + MyDrCrHead + "','" + Unit_Code + "','" + TDSNarration + "','" + TDS_Amt + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','D','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                        ds = obj.insertAccountMaster(ref strRef);
                        rev = strRef;
                        MyOrderCode = MyOrderCode + 1;
                    }
                    if (TDS_Amt != 0)
                    {
                        ...
                        obj.tableName = tblPrefix + "GLEDGER";
                        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + Purchase_TDS_Account + "','" + Unit_Code + "','" + TDSNarration + "','" + TDS_Amt + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                        ds = obj.insertAccountMaster(ref strRef);
                        rev = strRef;
                        MyOrderCode = MyOrderCode + 1;
                    }
    ...
    public void SugarSaleGledgerEffectForGST(string Tran_Type, int Doc_No, int Company_Code, int Year_Code)
    {
        try
        {
            ...
            if (MyDs.Tables[0].Rows.Count > 0)
            {
                ...
                string newsbno = MyDs.Tables[0].Rows[0]["newsbno"].ToString();
                ...
                string TransportNarration = Qntl + " " + TransportAmount + " " + MillShortName + " " + TransportShort + " Lorry: " + lorryNo + " " + PartyShort + " as per sale bill no " + newsbno;

                string UnitCity = clsCommon.getString("Select CityName from " + tblPrefix + "qryAccountsList where Ac_Code=" + Unit_Code + " and Company_Code=" + Company_Code + "");

                string DebitNarration = MillShortName + " " + Qntl + " Lorry: " + lorryNo + " " + BrokerShort + " " + UnitCity + " Purc.No:" + PURCNO + " " + PODetails + " as per sale bill no " + newsbno;

                string CreditNarration = PartyFullName + " " + Qntl + " " + " Lorry: " + lorryNo + " Do.No:" + DO_No + " as per sale bill no " + newsbno;
                double CGSTAmount = Convert.ToDouble(MyDs.Tables[0].Rows[0]["CGSTAmount"].ToString());
                double SGSTAmount = Convert.ToDouble(MyDs.Tables[0].Rows[0]["SGSTAmount"].ToString());
                double IGSTAmount = Convert.ToDouble(MyDs.Tables[0].Rows[0]["IGSTAmount"].ToString());
                ...
                double TCS_Amt = Convert.ToDouble(MyDs.Tables[0].Rows[0]["TCS_Amt"].ToString());
                string TCSNarration = "TCS " + PartyFullName + " " + MyDoc_No + " as per sale bill no " + newsbno;
                int Sale_TCS_Account = Convert.ToInt32(System.Web.HttpContext.Current.Session["SaleTCSAc"].ToString());

                double TDS_Amt = Convert.ToDouble(MyDs.Tables[0].Rows[0]["TDS_Amt"].ToString());
                string TDSNarration = "TDS " + PartyFullName + " " + MyDoc_No;
                int Sale_TDS_Account = Convert.ToInt32(System.Web.HttpContext.Current.Session["SaleTDSAc"].ToString());
              ...
              + " and COMPANY_CODE=" + Company_Code + " and YEAR_CODE=" + Year_Code + " and [ORDER_CODE] > " + totalcount);
                ...
                MyGL = new DataSet();
                MyGL = clsDAL.SimpleQuery("Select * from " + tblPrefix + "GLEDGER where TRAN_TYPE='" + Tran_Type + "' and DOC_NO=" + Doc_No + " and COMPANY_CODE="
                    + Company_Code + " and YEAR_CODE=" + Year_Code + "");
                mygledgercount = MyGL.Tables[0].Rows.Count;
                ...
                ds = clsDAL.SimpleQuery("Delete from " + tblPrefix + "GLEDGER where TRAN_TYPE='" + Tran_Type + "' and DOC_NO='" + MyDoc_No + "' and COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "'");
                using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
                {
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='"
                    //            + MyDoc_Date + "',AC_CODE='" + Transport_Ac + "',NARRATION='" + TransportNarration + "',AMOUNT='"
                    //            + Math.Abs(MyAmount) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //            "','" + TransportNarration + "','" + Math.Abs(MyAmount) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='"
                    //            + Sale_Account + "',NARRATION='" + CreditNarration + "',AMOUNT='" + Math.Round(Math.Abs(MyAmount - totalGSTAmount), 2)
                    //            + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='"
                    ...
                    //        obj.flag = 1;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code," +
                    //        "ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + Sale_Account + "','" + CreditNarration + "','"
                    //            + Math.Round(Math.Abs(MyAmount - totalGSTAmount), 2) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + SaleCGSTAc + "',NARRATION='" + CreditNarration + "',AMOUNT='" + Math.Abs(CGSTAmount) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + SaleCGSTAc + "','" + CreditNarration + "','" + Math.Abs(CGSTAmount) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + SaleSGSTAc + "',NARRATION='" + CreditNarration + "',AMOUNT='" + Math.Abs(SGSTAmount) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + SaleSGSTAc + "','" + CreditNarration + "','" + Math.Abs(SGSTAmount) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + SaleIGSTAc + "',NARRATION='" + CreditNarration + "',AMOUNT='" + Math.Abs(IGSTAmount) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='" + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='" + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + SaleIGSTAc + "','" + CreditNarration + "','" + Math.Abs(IGSTAmount) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //            + "',NARRATION='" + TCSNarration + "',AMOUNT='" + Math.Abs(TCS_Amt) + "',DRCR='D',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='"
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + MyDrCrHead + "','" + TCSNarration + "','"
                    //            + Math.Abs(TCS_Amt) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','D','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    //        obj.flag = 2;
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + Sale_TCS_Account
                    //            + "',NARRATION='" + TCSNarration + "',AMOUNT='" + Math.Abs(TCS_Amt) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='"
                    //            + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='"
                    //            + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                    //        obj.values = "none";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    ...
                    //        obj.tableName = tblPrefix + "GLEDGER";
                    //        obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                    //        obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + Sale_TCS_Account + "','" + TCSNarration + "','"
                    //            + Math.Abs(TCS_Amt) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                    //        ds = obj.insertAccountMaster(ref strRef);
                    //        rev = strRef;
                    //        MyOrderCode = MyOrderCode + 1;
                    //    }
                    ...
                    #region TCSEffect
                     ...
                     if (mygledgercount >= MyOrderCode)
                     {
                         if (TDS_Amt != 0)
                         {
                             ...
                             obj.tableName = tblPrefix + "GLEDGER";
                             obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + MyDrCrHead
                                 + "',NARRATION='" + TDSNarration + "',AMOUNT='" + Math.Abs(TDS_Amt) + "',DRCR='C',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='"
                                 + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='"
                                 + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                             obj.values = "none";
                             ds = obj.insertAccountMaster(ref strRef);
                     ...
                     else
                     {
                         if (TDS_Amt != 0)
                         {
                             ...
                             obj.tableName = tblPrefix + "GLEDGER";
                             obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                             obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + MyDrCrHead + "','" + TDSNarration + "','"
                                 + Math.Abs(TDS_Amt) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','C','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                             ds = obj.insertAccountMaster(ref strRef);
                             rev = strRef;
                             MyOrderCode = MyOrderCode + 1;
                         }
                     ...
                     if (mygledgercount >= MyOrderCode)
                     {
                         if (TDS_Amt != 0)
                         {
                             obj.flag = 2;
                             obj.tableName = tblPrefix + "GLEDGER";
                             obj.columnNm = "TRAN_TYPE='" + Tran_Type + "',DOC_NO='" + MyDoc_No + "',DOC_DATE='" + MyDoc_Date + "',AC_CODE='" + Sale_TDS_Account
                                 + "',NARRATION='" + TDSNarration + "',AMOUNT='" + Math.Abs(TDS_Amt) + "',DRCR='D',DRCR_HEAD='" + MyDrCrHead + "',SORT_TYPE='"
                                 + Tran_Type + "',SORT_NO='" + Doc_No + "' where COMPANY_CODE='" + Company_Code + "' AND YEAR_CODE='" + Year_Code + "' AND ORDER_CODE='"
                                 + MyOrderCode + "' AND TRAN_TYPE='" + Tran_Type + "' AND DOC_NO='" + MyDoc_No + "'";
                             obj.values = "none";
                             ds = obj.insertAccountMaster(ref strRef);
                     ...
                     else
                     {
                         if (TDS_Amt != 0)
                         {
                             ...
                             obj.tableName = tblPrefix + "GLEDGER";
                             obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,Branch_Code,ORDER_CODE,DRCR,DRCR_HEAD,SORT_TYPE,SORT_NO";
                             obj.values = "'" + Tran_Type + "','" + MyDoc_No + "','" + MyDoc_Date + "','" + Sale_TDS_Account + "','" + TDSNarration + "','"
                                 + Math.Abs(TDS_Amt) + "','" + Company_Code + "','" + Year_Code + "','" + Convert.ToInt32(System.Web.HttpContext.Current.Session["Branch_Code"].ToString()) + "','" + MyOrderCode + "','D','" + MyDrCrHead + "','" + Tran_Type + "','" + Doc_No + "'";
                             ds = obj.insertAccountMaster(ref strRef);
                             rev = strRef;
                             MyOrderCode = MyOrderCode + 1;
                         }
