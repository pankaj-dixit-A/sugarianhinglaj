        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (isAuthenticate == "1" || User_Type == "A")
                {
                    ...
                    {
                        hdnf.Value = Session["PR_NO"].ToString();
                        qry = getDisplayQuery();
        ...
        using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
        {
            ...
            if (ViewState["mode"] != null)
            {
                ...
                if (ViewState["mode"].ToString() == "I")
                {
                    ...
                    obj.columnNm = "DOC_NO,Tran_Type,PURCNO,PurcTranType,DOC_DATE,AC_CODE,Unit_Code,MILL_CODE,FROM_STATION,TO_STATION,LORRYNO,BROKER,WEARHOUSE,SUBTOTAL,LESS_FRT_RATE,FREIGHT,CASH_ADVANCE,BANK_COMMISSION,OTHER_AMT,BILL_AMOUNT,DUE_DAYS,NETQNTL,LCST,RCST,LSGST,RSGST,LIGST,RIGST,GST_Code,Company_Code,Year_Code,Branch_Code,Created_By,Bill_No";
