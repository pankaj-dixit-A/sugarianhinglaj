<%@ Page Title="Delivery Order" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeDeliveryorder.aspx.cs" Inherits="pgeDeliveryorder" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function od(do_no, email, PO, a) {
            var tn;
            window.open('../Report/rptDeliveryOrder.aspx?do_no=' + do_no + '&email=' + email + '&PO=' + PO + '&a=' + a);    //R=Redirected  O=Original
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                ...
                <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                    ...
                    <table cellspacing="5" align="left">
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                ...
                                <asp:DropDownList ID="drpDeliveryType" runat="server" CssClass="ddl" Width="140px"
                                    Enabled="true" TabIndex="4" AutoPostBack="true" Height="26px" OnSelectedIndexChanged="drpDeliveryType_SelectedIndexChanged">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                Email: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtMillEmailID" runat="server" CssClass="txt" Width="200px" AutoPostBack="True"
                                    OnTextChanged="txtMillEmailID_TextChanged" TabIndex="6" Height="24px"></asp:TextBox>
                        ...
                        <td colspan="2" align="left">
                            ...
                            <td colspan="3" align="left">
                                ...
                                <asp:Button ID="btntxtPurcNo" runat="server" Text="..." OnClick="btntxtPurcNo_Click"
                                    TabIndex="7" CssClass="btnHelp" Height="24px" Width="20px" />
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                <asp:TextBox ID="txtGETPASS_CODE" runat="Server" CssClass="txt" TabIndex="9" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                <asp:TextBox ID="txtvoucher_by" runat="Server" CssClass="txt" TabIndex="10" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6">
                                <asp:TextBox ID="txtGRADE" runat="Server" CssClass="txt" TabIndex="11" Width="150px"
                                ...
                                <asp:Button ID="btntxtGRADE" runat="server" Text="..." OnClick="btntxtGRADE_Click"
                                    CssClass="btnHelp" Height="24px" Width="20px" />
                                Quantal:
                                <asp:TextBox ID="txtquantal" runat="Server" CssClass="txt" TabIndex="12" Width="100px"
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Packing:&nbsp;&nbsp;
                                <asp:TextBox ID="txtPACKING" runat="Server" CssClass="txt" TabIndex="13" Width="100px"
                                ...
                                &nbsp;&nbsp;&nbsp;Bags:&nbsp;&nbsp;<asp:TextBox ID="txtBAGS" runat="Server" CssClass="txt"
                                    TabIndex="14" Width="100px" ReadOnly="true" Style="text-align: right;" AutoPostBack="True"
                                ...
                                &nbsp;Excise:&nbsp;
                                <asp:TextBox ID="txtexcise_rate" runat="Server" CssClass="txt" TabIndex="15" Width="100px"
                        ...
                        <tr>
                            <td align="left" style="border-bottom: 3px solid white;">
                                Mill Rate:
                            </td>
                            <td align="left" colspan="6" style="border-bottom: 3px solid white; vertical-align: top;">
                                <asp:TextBox ID="txtmillRate" runat="Server" CssClass="txt" TabIndex="16" Width="100px"
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sale
                                Rate:
                                <asp:TextBox ID="txtSALE_RATE" runat="Server" CssClass="txt" TabIndex="17" Width="100px"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;" colspan="3">
                                <asp:TextBox ID="txtDIFF_AMOUNT" runat="Server" CssClass="txt" TabIndex="18" Width="100px"
                                    ReadOnly="true" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtDIFF_AMOUNT_TextChanged"
                                    Height="24px"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Frieght:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox
                                    TabIndex="19" runat="server" ID="txtFrieght" CssClass="txt" Width="100px" Style="text-align: right;"
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList runat="server" Visible="false"
                                    Width="100px" ID="ddlFrieghtType" CssClass="ddl">
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                ...
                                &nbsp;rate:<asp:TextBox runat="server" ID="txtMemoAdvanceRate" Width="40px" Height="24px"
                                    TabIndex="21" AutoPostBack="true" CssClass="txt" OnTextChanged="txtMemoAdvanceRate_TextChanged"></asp:TextBox>
                                <asp:TextBox runat="server" ID="txtMemoAdvance" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="22" AutoPostBack="true" Height="24px" OnTextChanged="txtMemoAdvance_TextChanged"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;Freight Paid:<asp:TextBox runat="server" ID="txtVasuliRate" TabIndex="22"
                                    CssClass="txt" Width="100px" Style="text-align: right;" AutoPostBack="true" Height="24px"
                                    OnTextChanged="txtVasuliRate_TextChanged"></asp:TextBox>
                                ...
                                Vasuli Rate:<asp:TextBox runat="server" ID="txtVasuliRate1" CssClass="txt" Width="80px"
                                    TabIndex="24" Style="text-align: right;" AutoPostBack="true" Height="24px" OnTextChanged="txtVasuliRate1_TextChanged"></asp:TextBox>&nbsp;<asp:TextBox
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                <asp:TextBox ID="txtDO_CODE" runat="Server" CssClass="txt" TabIndex="25" Width="120px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                <asp:TextBox ID="txtBroker_CODE" runat="Server" CssClass="txt" TabIndex="26" Width="120px"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 13%;">
                                <asp:TextBox ID="txtTruck_NO" runat="Server" CssClass="txt" TabIndex="27" Width="140px"
                            ...
                            <td align="left" colspan="3" style="width: 10%;">
                                <asp:TextBox runat="server" ID="txtDriverMobile" CssClass="txt" TabIndex="28" Width="140px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3" style="width: 10%;">
                                <asp:TextBox ID="txtTRANSPORT_CODE" runat="Server" CssClass="txt" TabIndex="29" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">
                                <asp:TextBox ID="txtNARRATION1" runat="Server" CssClass="txt" TabIndex="30" Width="200px"
                            ...
                            <td align="left" style="width: 30%;">
                                <asp:TextBox ID="txtNARRATION3" runat="Server" CssClass="txt" TabIndex="32" Width="200px"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">
                                <asp:TextBox ID="txtNARRATION2" runat="Server" CssClass="txt" TabIndex="31" Width="200px"
                            ...
                            <td align="left" style="width: 30%;">
                                <asp:TextBox ID="txtNARRATION4" runat="Server" CssClass="txt" TabIndex="33" Width="200px"
                        ...
                        <tr>
                            <td align="left">
                                <asp:Button ID="btnOpenDetailsPopup" runat="server" Text="ADD" CssClass="btnHelp"
                                    Width="80px" Height="24px" OnClick="btnOpenDetailsPopup_Click" TabIndex="35" />&nbsp;&nbsp;&nbsp;Invoice
                                No:
                            </td>
                            <td colspan="4" align="left">
                                <asp:TextBox runat="server" ID="txtINVOICE_NO" CssClass="txt" Width="117px" Style="text-align: left;"
                                    TabIndex="34" AutoPostBack="True" Height="24px" OnTextChanged="txtINVOICE_NO_TextChanged"></asp:TextBox>&nbsp;&nbsp;CheckPost
            ...
            <table width="100%" align="left" cellspacing="5" cellpadding="4">
                <tr>
                    <td align="center" colspan="8">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            OnClientClick="return Vasuli();" ValidationGroup="add" OnClick="btnSave_Click"
                            ...
                            <table runat="server" width="100%">
                                <tr>
                                    <td style="width: 40%;">
                                        ...
                                        &nbsp;<asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btnSubmit"
                        ...
                        <td>
                            <asp:Panel ID="pnlInner" runat="server" Width="100%" Direction="LeftToRight" BackColor="#FFFFE4"
                                ...
                                <asp:GridView ID="grdPopup" runat="server" AutoGenerateColumns="true" AllowPaging="true"
                                    PageSize="40" EmptyDataText="No Records Found" HeaderStyle-BackColor="#6D8980"
            ...
            <asp:Panel ID="pnlPopupDetails" runat="server" BackColor="GhostWhite" Width="800px"
                ...
                <table width="80%" align="center" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:DropDownList ID="drpddType" runat="server" CssClass="ddl" TabIndex="36" Width="200px"
                                Height="30px">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtBANK_CODE" runat="Server" CssClass="txt" TabIndex="37" Width="60px"
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="left">
                            <asp:TextBox ID="txtUTRNo" CssClass="txt" Width="80px" runat="server" AutoPostBack="true"
                                OnTextChanged="txtUTRNo_TextChanged" TabIndex="38" Height="24px"></asp:TextBox>
                            <asp:Button ID="btntxtUTRNo" runat="server" CssClass="btnHelp" Text="UTR No" Width="80px"
                                OnClick="btntxtUTRNo_Click" Height="24px" />
                            <asp:Label ID="lblUTRYearCode" runat="server" CssClass="lblName"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtNARRATION" runat="Server" CssClass="txt" TabIndex="39" Height="24px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtBANK_AMOUNT" runat="Server" CssClass="txt" TabIndex="40" Height="24px"
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnSubmit" Width="80px"
                                Height="25px" OnClick="btnAdddetails_Click" TabIndex="42" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnSubmit"
                                Width="80px" Height="25px" OnClick="btnClosedetails_Click" TabIndex="41" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
