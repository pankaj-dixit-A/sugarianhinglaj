<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGSTRateMaster.aspx.cs" Inherits="Sugar_pgeGSTRateMaster" %>
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtGST_Code") {
                    ...
                    document.getElementById("<%=lblCode_Name.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 80%;margin-left:70px;margin-top:50px;" align="center" cellpadding="5" cellspacing="5" >
                    <tr>
                        <td align="Right">
                            Change No:
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left"> 
                            <asp:TextBox ID="txtIGST" runat="server" CssClass="txt" Width="10%" TabIndex="3" 
                                Height="24px"></asp:TextBox>
                                 <ajax1:FilteredTextBoxExtender runat="server"
                    ...
                    <tr>
                        ...
                        <td align="left"> 
                            <asp:TextBox ID="txtSGST" runat="server" CssClass="txt" Width="10%" TabIndex="3" 
                                Height="24px"></asp:TextBox>
                                 <ajax1:FilteredTextBoxExtender runat="server"
                    ...
                    <tr>
                        ...
                        <td align="left"> 
                            <asp:TextBox ID="txtCGST" runat="server" CssClass="txt" Width="10%" TabIndex="3" 
                                Height="24px"></asp:TextBox>
                                 <ajax1:FilteredTextBoxExtender runat="server"
                    ...
                    <tr>
                        ...
                        <td align="left"> 
                            <asp:TextBox ID="txtRemark" runat="server" CssClass="txt" Width="30%" TabIndex="3" TextMode="MultiLine"
                   ...
                   <tr>
                        ...
                        <td align="left"> 
                            <asp:TextBox ID="txtGST_Code" runat="server" CssClass="txt" Width="10%" TabIndex="3" AutoPostBack="true" OnTextChanged="txtGST_Code_TextChanged" 
                                Height="24px"></asp:TextBox>
            ...
            <table width="80%" align="left" cellpadding="10px" cellspacing="10px">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="btnHelp" Width="90px" TabIndex="4"
            ...
            <asp:Panel ID="pnlPopup" onkeydown="closepopup(event);"  runat="server" Width="70%" align="center" ScrollBars="None"
                ...
                background-position: center; left: 10%; top: 10%; margin: 0 auto;">
