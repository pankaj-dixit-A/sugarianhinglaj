...
public partial class Sugar_pgecityMaster : System.Web.UI.Page
{
    ...
    private void showLastRecord()
    {
        ...
        {
            string qry = string.Empty;
            qry = "select max(city_code) as doc_no from " + tblHead +
    ...
    private void enableDisableNavigateButtons()
    {
        ...
        if (txtdoc_no.Text != string.Empty)
        {
            if (hdnf.Value != string.Empty)
            {
                ...
                query = "SELECT top 1 [city_code] from " + tblHead + " where city_code>" + Convert.ToInt32(hdnf.Value) +
    ...
    protected void btnFirst_Click(object sender, EventArgs e)
    {
        ...
        {
            string query = "";
            query = "select city_code from " + tblHead + " where city_code=(select MIN(city_code) from " + tblHead + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + ") " +
                "   and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString());
    ...
    protected void btnPrevious_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtdoc_no.Text != string.Empty)
            {
                string query = "SELECT top 1 [city_code] from " + tblHead + " where city_code<" + Convert.ToInt32(hdnf.Value) +
                    " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) +
    ...
    protected void btnLast_Click(object sender, EventArgs e)
    {
        ...
        {
            string query = "";
            query = "select city_code from " + tblHead + " where city_code=(select MAX(city_code) from " + tblHead + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + ") " +
                "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString());
        ...
        try
        {
            if (hdconfirm.Value == "Yes")
            {
                ...
                using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
                {
                    ...
                    obj.columnNm = " city_code=" + currentDoc_No + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString());
                    obj.values = "none";
                ...
                if (strrev == "-3")
                {
                    query = "SELECT top 1 [city_code] from " + tblHead + "  where city_code>" + Convert.ToInt32(currentDoc_No) +
                           "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) +
                            " ORDER BY city_code asc  ";
                    hdnf.Value = clsCommon.getString(query);
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        string str = clsCommon.getString("select count(city_code) from " + tblHead + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
    ...
    private string getDisplayQuery()
    {
        try
        {
            string qryDisplay = "select * from " + tblHead + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and city_code=" + hdnf.Value;
            return qryDisplay;
        }
        catch
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string city_name_e = txtcityNameE.Text;
            string city_name_r = txtcityNameR.Text;
                ...
                using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
                {
                    if (ViewState["mode"] != null)
                    {
                        ...
                        if (ViewState["mode"].ToString() == "I")
                        {
                            ...
                            obj.values = "'" + DOC_NO + "','" + city_name_e + "','" + city_name_r + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + state + "','" + Created_By + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                            retValue = strRev;
                        }
                        if (ViewState["mode"].ToString() == "U")
                        {
                            obj.flag = 2;
                            obj.tableName = tblHead;
                            obj.columnNm = " city_name_e='" + city_name_e + "',city_name_r='" + city_name_r + "',state='" + state + "',Modified_By='" + Modified_By + "' where city_code='" + txtdoc_no.Text + "' and company_code=" + Convert.ToInt32(Session["Company_Code"].ToString());
                            obj.values = "none";
                            ds = obj.insertAccountMaster(ref strRev);
                            retValue = strRev;
                        }
