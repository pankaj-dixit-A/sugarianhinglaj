<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeGSTCodeMaster.aspx.cs" Inherits="Sugar_pgeGSTCodeMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
        ...
        <legend style="text-align: center;">
            <asp:Label ID="label1" runat="server" Text="   Goods and Services Code Master   "
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 80%; margin-left: 70px; margin-top: 50px;" align="center" cellpadding="5"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtCode_Name" runat="server" CssClass="txtUpper" Width="438px" TabIndex="2"
                                Height="24px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtRemark" runat="server" CssClass="txt" Width="438px" TabIndex="3"
                                Height="24px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
