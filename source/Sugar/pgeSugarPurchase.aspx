<%@ Page Title="Purchase" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeSugarPurchase.aspx.cs" Inherits="Sugar_pgeSugarPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
        ...
        <legend style="text-align: center;">
            <asp:Label ID="label1" runat="server" Text="   Sugar Purchase   " Font-Names="verdana"
                ...
                <table width="90%" align="left" cellspacing="4">
                    <tr>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">
                                <asp:TextBox ID="txtPURCNO" runat="Server" CssClass="txt" TabIndex="1" Width="80px" ReadOnly="true"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="2">
                                <asp:TextBox ID="txtbillNo" runat="Server" CssClass="txt" TabIndex="11" Width="260px"
                            ...
                            <td style="width: 100%;" align="right" colspan="7">
                                <table width="100%" cellspacing="4" cellpadding="3">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            Due Days:
                                            <asp:TextBox ID="txtDUE_DAYS" runat="Server" CssClass="txt" TabIndex="26" Width="120px"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtCASH_ADVANCE" runat="Server" CssClass="txt" TabIndex="25" Width="120px"
