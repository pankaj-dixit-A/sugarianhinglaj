...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function EInovice() {
            ...
            var tran_type = $("#<%=drpSub_Type.ClientID %>").val();
            window.open('../Sugar/pgeEInovice.aspx?dono=' + dono + '&Type=' + tran_type);
        }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pagevalidation() {
            ...
            XML = XML + "<DebitHead " + HeadInsertUpdate + " doc_date='" + Entry_date + "' ac_code='" + AcCode + "' bill_no='" + Bill_No + "' bill_date='" + Bill_date + "' " +
                ...
                "Mill_Code='" + Millcode + "' st='" + st + "' mc='" + mc + "' ackno='" + ackno + "' Unit_Code='" + Unitcode + "' uc='" + uc + "' TCS_Rate='" + TCS_Rate + "' TCS_Amt='" + TCS_Amt + "' TCS_Net_Payable='" + TCS_Net_Payable + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "'>";
            ...
            function OnSuccess(response) {
                ...
                if (status != "Delete") {
                    if (response.d.length > 0) {
                        ...
                        window.open('../Sugar/pgeDebitCreditNote.aspx?dcid=' + id + '&Action=' + action + '&tran_type=' + Tran_Type, "_self");
                    ...
                    if (isNaN(num)) {
                        ...
                        window.open('../Sugar/PgeDebitCreditNoteUtility.aspx', "_self");
                    }
                }
