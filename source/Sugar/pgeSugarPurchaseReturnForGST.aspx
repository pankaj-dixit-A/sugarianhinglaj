<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeSugarPurchaseReturnForGST.aspx.cs" Inherits="Sugar_pgeSugarPurchaseReturnForGST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function SB() {
            ...
            window.open('../Report/rptSaleReturn.aspx?billno=' + billno)
        }</script>
                                ...
                                <table width="100%" cellspacing="4" cellpadding="3">
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLCST" runat="Server" CssClass="txt" Width="52px" TabIndex="23"
                                            ...
                                            <asp:TextBox ID="txtRCST" runat="Server" CssClass="txt" Width="80px" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLSGST" runat="Server" CssClass="txt" Width="50px" TabIndex="24"
                                            ...
                                            <asp:TextBox ID="txtRSGST" runat="Server" CssClass="txt" Width="82px" 
                                                ReadOnly="true" Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtLIGST" runat="Server" CssClass="txt" Width="52px" AutoPostBack="true"
                                                OnTextChanged="txtLIGST_TextChanged" TabIndex="25" Style="text-align: right;"
                                                Height="24px"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtIGST" runat="Server" CssClass="txt" Width="80px" 
                                                ReadOnly="true" Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtLESS_FRT_RATE" runat="Server" CssClass="txt" TabIndex="26" Width="52px"
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            TabIndex="32" Height="24px" ValidationGroup="add" OnClick="btnSave_Click" />
                        &nbsp;
