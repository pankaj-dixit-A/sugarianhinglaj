...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function SB() {
            ...
            window.open('../Report/rptReturnSaleBill.aspx?billno=' + billno);
        }</script>
    <script type="text/javascript">
        function Confirm() {
                    ...
                    <tr>
                        <td align="left" colspan="4" style="width: 100%;">
                            ...
                            <ajax1:FilteredTextBoxExtender ID="FilteredtxtNETQNTL" runat="server" FilterType="Numbers,Custom"
                             ...
                             Due Days:
                            <asp:TextBox ID="txtDUE_DAYS" runat="Server" CssClass="txt" TabIndex="31" Width="120px"
                            ...
                            <ajax1:FilteredTextBoxExtender ID="filtertxtDUE_DAYS" runat="server" FilterType="Numbers"
                              ...
                              Transport:
                            <asp:TextBox ID="txtTransportCode" runat="Server" CssClass="txt" TabIndex="32" Width="80px"
                        ...
                        <td style="width: 100%;" align="right">
                            <table width="100%" cellspacing="4" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtLCST" runat="Server" CssClass="txt" Width="52px" TabIndex="22"
                                        ...
                                        <ajax1:FilteredTextBoxExtender ID="FilteredtxtLCST" runat="server" FilterType="Numbers,Custom"
                                            TargetControlID="txtLCST" ValidChars=".">
                                        </ajax1:FilteredTextBoxExtender>
                                        <asp:TextBox ID="txtRCST" runat="Server" CssClass="txt" Width="80px" ReadOnly="true"
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtLSGST" runat="Server" CssClass="txt" Width="50px" TabIndex="23"
                                        ...
                                        <ajax1:FilteredTextBoxExtender ID="FilteredtxtLSGST" runat="server" FilterType="Numbers,Custom"
                                            TargetControlID="txtLSGST" ValidChars=".">
                                        </ajax1:FilteredTextBoxExtender>
                                        <asp:TextBox ID="txtRSGST" runat="Server" CssClass="txt" Width="82px" ReadOnly="true"
                                            Style="text-align: right;" Height="24px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtLIGST" runat="Server" CssClass="txt" Width="52px" AutoPostBack="true"
                                            OnTextChanged="txtLIGST_TextChanged" TabIndex="24" Style="text-align: right;"
                                            Height="24px"></asp:TextBox>
                                        <ajax1:FilteredTextBoxExtender ID="FilteredtxtLIGST" runat="server" FilterType="Numbers,Custom"
                                            TargetControlID="txtLIGST" ValidChars=".">
                                        </ajax1:FilteredTextBoxExtender>
                                        <asp:TextBox ID="txtIGST" runat="Server" CssClass="txt" Width="80px" ReadOnly="true"
                                            Style="text-align: right;" Height="24px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtLESS_FRT_RATE" runat="Server" CssClass="txt" TabIndex="25" Width="52px"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtBANK_COMMISSION" runat="Server" CssClass="txt" TabIndex="26"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtOTHER_AMT" runat="Server" AutoPostBack="True" CssClass="txt"
                                            ...
                                            TabIndex="27" Width="140px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtCASH_ADVANCE" runat="Server" CssClass="txt" TabIndex="28" Width="140px"
