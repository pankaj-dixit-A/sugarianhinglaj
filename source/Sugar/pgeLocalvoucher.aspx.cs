...
using System.Data;
public partial class pgeLocalvoucher : System.Web.UI.Page
{
    #region data section
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (transportcode.Trim()!=string.Empty)
                        {
        ...
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtdoc_no")
            {
                ...
                " " + tblHead + " ON Party.Ac_Code = " + tblHead + ".Ac_Code and Party.Company_Code = " + tblHead + ".Company_Code where " + tblHead + ".Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) +
                    ...
                    " and " + tblHead + ".Tran_Type='" + Tran_Type + "' ";
                this.showPopup(qry);
            }
                ...
                using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
                {
                    if (ViewState["mode"] != null)
                    {
                        ...
                        if (ViewState["mode"].ToString() == "I")
                        {
                            ...
                            " Company_Code, Year_Code , Branch_Code,Created_By,Commission_Rate";
                            ...
                            " '" + OTHER_EXPENSES + "','" + VOUCHER_AMOUNT + "','" + Diff_Amount + "','" + Due_Days + "'," +
                            " '" + Company_Code + "','" + Year_Code + "','" + Branch_Code + "','" + user + "','" + Commission_Rate + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                            retValue = strRev;
                        ...
                        if (ViewState["mode"].ToString() == "U")
                        {
                            ...
                            " OTHER_EXPENSES='" + OTHER_EXPENSES + "', VOUCHER_AMOUNT='" + VOUCHER_AMOUNT + "',Diff_Amount='" + Diff_Amount + "',Due_Days='" + Due_Days + "',Modified_By='" + user + "',Commission_Rate='" + Commission_Rate + "' where " +
                        ...
                        if (VOUCHER_AMOUNT > 0)
                        {
                            ...
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + AC_CODE + "','" + NARRATION1 + myNarration + "','" + Math.Abs(VOUCHER_AMOUNT) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        }
                        else
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + AC_CODE + "','" + NARRATION1 + myNarration + "','" + Math.Abs(VOUCHER_AMOUNT) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','C','" + 0 + "','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        }
                        ...
                        if (Diff_Amount > 0)
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + NARRATION1 + " " + lblAc_name.Text + " " + "','" + Math.Abs(VOUCHER_AMOUNT) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        }
                        else
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + NARRATION1 + " " + lblAc_name.Text + " " + "','" + Math.Abs(VOUCHER_AMOUNT) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        ...
                        if (RDIFFTENDER != 0)
                        {
                            ...
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["QUALITY_DIFF_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        }
                        if (POSTAGE != 0)
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,TENDER_ID,TENDER_ID_DETAIL,VOUCHER_ID,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,DRCR_HEAD,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["POSTAGE_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        }
                        ...
                        if (RESALE_COMMISSON != 0)
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,TENDER_ID,TENDER_ID_DETAIL,VOUCHER_ID,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,DRCR_HEAD,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["COMMISSION_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
                            ds = obj.insertAccountMaster(ref strRev);
                        ...
                        if (BANK_COMMISSION != 0)
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,TENDER_ID,TENDER_ID_DETAIL,VOUCHER_ID,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,DRCR_HEAD,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["BANK_COMMISSION_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
                        ...
                        if (FREIGHT != 0)
                        {
                            ...
                            obj.tableName = GLedgerTable;
                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,TENDER_ID,TENDER_ID_DETAIL,VOUCHER_ID,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,DRCR_HEAD,ADJUSTED_AMOUNT,Branch_Code";
                            obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["MOTOR_FREIGHT_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
                        ...
                        //    obj.tableName = GLedgerTable;
                        //    obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,NARRATION,AMOUNT,TENDER_ID,TENDER_ID_DETAIL,VOUCHER_ID,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,DRCR_HEAD,ADJUSTED_AMOUNT,Branch_Code";
                        //    obj.values = "'" + Tran_Type + "','" + DOC_NO + "','" + DOC_DATE + "','" + Session["OTHER_AMOUNT_AC"].ToString() + "','" + NARRATION1 + myNarration + "','" + Math.Abs(amt) + "',null,null,null,'" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + drcr + "','" + AC_CODE + "','0','" + Branch_Code + "'";
