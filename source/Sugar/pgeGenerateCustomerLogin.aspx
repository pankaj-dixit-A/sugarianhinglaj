<%@ Page Title="Customer Login" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeGenerateCustomerLogin.aspx.cs" Inherits="Sugar_pgeGenerateCustomerLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <b>Search Account:</b><asp:TextBox runat="server" ID="txtSearch" Width="250px" ForeColor="Gray"
        Height="24px"></asp:TextBox>&nbsp;<asp:Button runat="server" ID="btnSearch" Text="Search"
    ...
    <asp:Panel ID="pnlGeneratedAccounts" runat="server" Font-Names="verdana" Font-Bold="true"
        ...
        z-index: 100;" Width="700px" BorderColor="Blue" BorderWidth="1px">
        <br />
    ...
    <asp:Button runat="server" ID="btnGenerate" OnClick="btnGenerate_Click" CssClass="btnHelp"
        OnClientClick="javascript:validateCheckBoxes();" Width="100px" Height="25px" />&nbsp;<asp:Button
