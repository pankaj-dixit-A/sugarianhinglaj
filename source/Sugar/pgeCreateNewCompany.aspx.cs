...
public partial class pgeCreateNewCompany : System.Web.UI.Page
{
    ...
    private string saveData()
    {
        try
        {
            ...
            using (clsCompany obj = new clsCompany())
            {
                ...
                obj.FSSAI_No = txtFSSAI.Text;
                obj.CST = txtCSTNo.Text;
                obj.TIN = txtTinNo.Text;
                obj.GST= txtGST.Text;
                obj.PHONE = txtPhone.Text;
                obj.Group_Code = Session["Group_Code"].ToString();
