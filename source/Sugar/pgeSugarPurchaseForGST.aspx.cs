...
public partial class Sugar_pgeSugarPurchaseForGST : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            qryCommon = tblPrefix + "qrySugarPurcList";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       // DateTime docdate = Convert.ToDateTime(dt11);
        ...
        if (docdate >= TDSDate)
        {
            txtTDSRate.Text = Session["PurchaseTDS_Rate"].ToString();
        }
        else
        {
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            if (hdconfirm.Value == "Yes")
            {
                ...
                {
                    ds = new DataSet();
                    qry = "update " + tblPrefix + "deliveryorder SET voucher_no=0,voucher_type=NULL where doc_no='" + DONumber + "' and tran_type='DO' and company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "";
                    ds = clsDAL.SimpleQuery(qry);
                }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (txtDOC_DATE.Text != string.Empty)
        {
            ...
            if (clsCommon.isValidDate(txtDOC_DATE.Text) == true || txtDOC_DATE.Text == "31/03/2017")
            {
                isValidated = true;
            }
            else
        ...
        using (clsUniversalInsertUpdateDelete obj = new clsUniversalInsertUpdateDelete())
        {
            ...
            if (ViewState["mode"] != null)
            {
                ...
                if (ViewState["mode"].ToString() == "I")
                {
                    ...
                    obj.columnNm = "DOC_NO,Tran_Type,PURCNO,DOC_DATE,AC_CODE,Unit_Code,MILL_CODE,FROM_STATION,TO_STATION,LORRYNO,BROKER,WEARHOUSE,SUBTOTAL,LESS_FRT_RATE,FREIGHT,CASH_ADVANCE,BANK_COMMISSION,OTHER_AMT,BILL_AMOUNT,DUE_DAYS,NETQNTL,CGSTRate,CGSTAmount,SGSTRate,SGSTAmount,IGSTRate,IGSTAmount,GstRateCode,Company_Code,Year_Code,Branch_Code,Created_By,Bill_No,TCS_Rate,TCS_Amt,TCS_Net_Payable,TDS_Rate,TDS_Amt";
                    obj.values = "'" + DOC_NO + "','" + trntype + "','" + PURCNO + "','" + DOC_DATE + "','" + AC_CODE + "','" + Unit_Code + "','" + MILL_CODE + "','" + FROM_STATION + "','" + TO_STATION + "','" + LORRYNO + "','" + BROKER + "','" + WEARHOUSE + "','" + SUBTOTAL + "','" + LESS_FRT_RATE + "','" + FREIGHT + "','" + CASH_ADVANCE + "','" + BANK_COMMISSION + "','" + OTHER_AMT
                        + "','" + BILL_AMOUNT + "','" + DUE_DAYS + "','" + NETQNTL + "','" + CGSTRate + "','" + CGSTAmount + "','" + SGSTRate + "','" + SGSTAmount + "','" + IGSTRate + "','" + IGSTAmount + "','" + GstRateCode + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString())
                        + "','" + Convert.ToInt32(Session["Branch_Code"].ToString()) + "','" + user + "','" + billNo + "','" + TCS_Rate + "','" + TCS_Amt + "','" + TCS_Net_Payable + "','" + TDS_Rate + "','" + TDS_Amt + "'";
                ...
                else
                {
                    ...
                    obj.flag = 2;
                    obj.tableName = tblHead;
                    obj.columnNm = "DOC_NO='" + DOC_NO + "',Tran_Type='" + trntype + "',PURCNO='" + PURCNO + "',DOC_DATE='" + DOC_DATE + "',AC_CODE='"
                        + AC_CODE + "',Unit_Code='" + Unit_Code + "',MILL_CODE='" + MILL_CODE + "',FROM_STATION='" + FROM_STATION
                        + "',TO_STATION='" + TO_STATION + "',LORRYNO='" + LORRYNO + "',BROKER='" + BROKER + "',WEARHOUSE='" + WEARHOUSE + "',SUBTOTAL='"
                        + SUBTOTAL + "',LESS_FRT_RATE='" + LESS_FRT_RATE + "',FREIGHT='" + FREIGHT + "',CASH_ADVANCE='" + CASH_ADVANCE + "',BANK_COMMISSION='"
                        + BANK_COMMISSION + "',OTHER_AMT='" + OTHER_AMT + "',BILL_AMOUNT='" + BILL_AMOUNT + "',DUE_DAYS='" + DUE_DAYS + "',NETQNTL='"
                        + NETQNTL + "',CGSTRate='" + CGSTRate + "',CGSTAmount='" + CGSTAmount + "',SGSTRate='" + SGSTRate + "',SGSTAmount='" + SGSTAmount
                        + "',IGSTRate='" + IGSTRate + "',IGSTAmount='" + IGSTAmount + "',GstRateCode='" + GstRateCode + "',Modified_By='" + user + "',Bill_No='"
                        + billNo + "',TCS_Rate='" + TCS_Rate + "',TCS_Amt='" + TCS_Amt + "',TCS_Net_Payable='" + TCS_Net_Payable + "',TDS_Rate='" + TDS_Rate + "',TDS_Amt='" + TDS_Amt + "' where doc_no=" + DOC_NO + " and Tran_Type='" + trntype + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                ...
                if (strRev == "-1" || strRev == "-2")
                {
                    if (grdDetail.Rows.Count > 0)
                    {
                        ...
                        if (txtDOC_DATE.Text != "31/03/2017")
                        {
                            gleder.SugarPurchaseGledgerEffectForGST(trntype, DOC_NO, Convert.ToInt32(Session["Company_Code"].ToString()), Convert.ToInt32(Session["year"].ToString()));
                        }
                    }
                    else
                    {
