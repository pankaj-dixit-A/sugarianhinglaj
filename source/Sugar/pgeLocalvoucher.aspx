<%@ Page Title="Local Voucher" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeLocalvoucher.aspx.cs" Inherits="pgeLocalvoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 80%;" align="left" cellpadding="2" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNarration1" runat="Server" CssClass="txt" TabIndex="24" Width="350px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNarration2" runat="Server" CssClass="txt" TabIndex="25" Width="350px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNarration3" runat="Server" CssClass="txt" TabIndex="27" Width="350px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNarration4" runat="Server" CssClass="txt" TabIndex="28" Width="350px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtVoucher_Amount" runat="Server" CssClass="txt" Width="110px" Style="text-align: right;"
            ...
            <asp:Panel ID="pnlPopup" runat="server" autosize="true" Width="80%" align="center"
                ScrollBars="None" BackColor="#FFFFE4" Direction="LeftToRight" Style="z-index: 5000;
                        ...
                        <td>
                            <asp:Panel ID="pnlInner" runat="server" ScrollBars="Auto" autosize="true" Width="100%"
                                ...
                                <asp:GridView ID="grdPopup" runat="server" AutoGenerateColumns="true" AllowPaging="true"
                                    PageSize="25" EmptyDataText="No Records Found" HeaderStyle-BackColor="#6D8980"
