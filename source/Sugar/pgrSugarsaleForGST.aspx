<%@ Page Title="Sale Bill For GST" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="pgrSugarsaleForGST.aspx.cs" Inherits="Sugar_pgrSugarsaleForGST" %>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="90%" align="left" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td align="right" style="width: 10%;" colspan="4">
                            Date:
                    ...
                    <tr>
                        <td style="width: 100px; vertical-align: top;" align="center">
                            <asp:Button ID="btnOpenDetailsPopup" runat="server" Text="ADD" CssClass="btnHelp"
                                Width="80px" Height="24px" OnClick="btnOpenDetailsPopup_Click" TabIndex="12" />
                        </td>
                    </tr>
                    <tr>
                        <td align="left" colspan="4" style="width: 100%; margin-top: 0px;">
                            ...
                            <div style="margin-top: 160px; margin-left: 70px;">
                                ...
                                <asp:TextBox ID="txtNETQNTL" runat="Server" CssClass="txt" ReadOnly="true" Width="120px"
                                    ...
                                    TabIndex="33" Height="24px"></asp:TextBox>
                            ...
                            <div style="margin-left: 35px; margin-top: 20px;">
                                ...
                                Transport:
                                <asp:TextBox ID="txtTransportCode" runat="Server" CssClass="txt" TabIndex="35" Width="80px"
                            ...
                            <div style="margin-left: 35px; margin-top: 20px;">
                                ...
                                <asp:TextBox ID="txtEwaybill" runat="Server" CssClass="txt" TabIndex="36" Width="200px"
                                    Style="text-align: right;" AutoPostBack="True" Height="24px" OnTextChanged="txtEwaybill_TextChanged"></asp:TextBox>
                            </div>
                            <div style="margin-left: 35px; margin-top: 20px;">
                                New SB No:
                        ...
                        <td style="width: 100%;" align="right">
                            <table width="130%" cellspacing="4" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLESS_FRT_RATE" runat="Server" CssClass="txt" TabIndex="25" Width="50px"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtTaxableAmount" runat="Server" CssClass="txt" ReadOnly="true"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtBankCommRate" runat="Server" CssClass="txt" Width="50px" Style="text-align: right;"
                                            AutoPostBack="True" Height="24px" TabIndex="26" OnTextChanged="txtBankCommRate_TextChanged"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtCASH_ADVANCE" runat="Server" CssClass="txt" TabIndex="29" Width="140px"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtroundoff" runat="Server" CssClass="txt" TabIndex="29" Width="140px"
                                            Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtrondoff_TextChanged"
                                            Height="24px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtTDSRate" runat="Server" CssClass="txt" Width="52px" AutoPostBack="true"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtTCSNet_Payable" runat="Server" CssClass="txt" ReadOnly="true"
                                            TabIndex="32" Width="140px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtTCSNet_Payable_TextChanged"
                                            Height="24px"></asp:TextBox>
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            Height="24px" ValidationGroup="add" OnClick="btnSave_Click" TabIndex="37" />
                        &nbsp;
