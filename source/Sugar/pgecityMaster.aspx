    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 80%;" align="left" cellpadding="5" cellspacing="5">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtState" runat="server" CssClass="txt" Width="441px" TabIndex="4"
                                AutoPostBack="false" OnTextChanged="txtState_TextChanged" Height="24px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
