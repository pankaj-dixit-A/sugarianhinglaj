<%@ Page Title="JV" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeJournalvoucher.aspx.cs" Inherits="Sugar_pgeJournalvoucher" %>
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtdebit_ac") {
                    ...
                    document.getElementById("<%=txtcredit_ac.ClientID %>").focus();
                }
                if (hdnfClosePopupValue == "txtcredit_ac") {
                    document.getElementById("<%=txtcredit_ac.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                    document.getElementById("<%=lblCredit_name.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
        ...
        <legend style="text-align: center;">
            <asp:Label ID="label1" runat="server" Text="   Journal Voucher   " Font-Names="verdana"
                        ...
                        <td>
                            <asp:Panel ID="pnlInner" runat="server" Width="100%" Direction="LeftToRight" BackColor="#FFFFE4"
                                ...
                                <asp:GridView ID="grdPopup" runat="server" AutoGenerateColumns="true" EmptyDataText="No Records Found"
                                    AllowPaging="true" PageSize="20" HeaderStyle-BackColor="#6D8980" HeaderStyle-ForeColor="White"
            ...
            <asp:Panel ID="pnlPopupDetails" runat="server" BackColor="GhostWhite" Width="955px"
                ...
                <table width="90%" align="center" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtdebit_ac" runat="Server" CssClass="txt" TabIndex="2" Width="80px"
                                Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtdebit_ac_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtcredit_ac" runat="Server" CssClass="txt" TabIndex="3" Width="80px"
                                Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtcredit_ac_TextChanged"></asp:TextBox>
                            <asp:Button ID="btntxtcredit_ac" runat="server" Text="..." OnClick="btntxtcredit_ac_Click"
                                CssClass="btnHelp" Height="24px" Width="20px" />
                            <asp:Label ID="lblCredit_name" runat="server" CssClass="lblName"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" style="width: 10%;">
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtamount" runat="Server" CssClass="txt" TabIndex="4" Width="80px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtnarration" runat="Server" CssClass="txt" TabIndex="5" Width="180px"
                                Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtnarration_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnSubmit" Width="80px"
                                Height="25px" OnClick="btnAdddetails_Click" TabIndex="6" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnSubmit"
                                Width="80px" Height="25px" OnClick="btnClosedetails_Click" TabIndex="7" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
