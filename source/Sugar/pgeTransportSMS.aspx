<%@ Page Title="Transport SMS" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeTransportSMS.aspx.cs" Inherits="Sugar_pgeTransportSMS" %>
                    ...
                    <td style="width: 100%" align="left">
                        <asp:Panel ID="pnlGrid" runat="server" align="left" BorderColor="Blue" BorderWidth="1px"
                            ...
                            <asp:GridView runat="server" ID="grdDetails" AutoGenerateColumns="false" CellPadding="6"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Mill" DataField="millname" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField HeaderText="Party City" DataField="CityName" ItemStyle-HorizontalAlign="Center" />
                ...
                <tr>
                    <td style="width: 100%" align="left">
                        <asp:TextBox runat="server" ID="txtMessage" TextMode="MultiLine" Width="900px" Height="100px"
                            Enabled="false" Style="background-color: White;"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="width: 60%" align="left">
                        ...
                        <asp:TextBox runat="server" ID="txtSmsGroup" Width="80px" Height="24px" CssClass="txt"
                            AutoPostBack="true" OnTextChanged="txtSmsGroup_TextChanged"></asp:TextBox>&nbsp;<asp:Button
                                ...
                                Height="24px" OnClick="btntxtSmsGroup_Click" />&nbsp;<asp:Label runat="server" ID="lblGroupName"
                                    CssClass="lblName"></asp:Label>&nbsp; &nbsp;&nbsp;&nbsp;<b>Ac_Code:</b>&nbsp;<asp:TextBox
                                        AutoPostBack="true" ID="txtAc_Code" Width="80px" Height="24px" CssClass="txt"
                                        runat="server" OnTextChanged="txtAc_Code_TextChanged"></asp:TextBox>&nbsp;<asp:Button
                                    ...
                                    <asp:TemplateField HeaderText="Mobile">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtMobile" Width="150px" Height="24px" Text='<%#Eval("Mobile") %>'
                                                CssClass="txt" MaxLength="10"></asp:TextBox>
            ...
            <asp:Panel ID="pnlPopup" runat="server" Width="70%" align="center" ScrollBars="None"
                ...
                <table width="95%">
                    ...
                    <tr>
                        <td>
                            Search Text:
                            <asp:TextBox ID="txtSearchText" runat="server" Width="250px" Height="20px" AutoPostBack="false"
                        ...
                        <td>
                            <asp:Panel ID="pnlInner" runat="server" Width="100%" Direction="LeftToRight" BackColor="#FFFFE4"
                                ...
                                <asp:GridView ID="grdPopup" runat="server" AutoGenerateColumns="true" AllowPaging="true"
                                    PageSize="30" EmptyDataText="No Records Found" HeaderStyle-BackColor="#6D8980"
