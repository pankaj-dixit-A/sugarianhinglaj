<%@ Page Title="Create New Company" Language="C#" AutoEventWireup="true" CodeFile="pgeCreateNewCompany.aspx.cs"
    Inherits="pgeCreateNewCompany" %>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" OnClientClick="Confirm()"
                                                        Width="80px" ValidationGroup="add" OnClick="btnDelete_Click" />
                                                    &nbsp;
