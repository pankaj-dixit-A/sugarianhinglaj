<%@ Page Title="Delivery Order" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeDeliveryOrder2.aspx.cs" Inherits="pgeDeliveryOrder2" %>
                                    ...
                                    <tr>
                                        <td align="left" colspan="8">
                                            <asp:Button ID="btnAdd" runat="server" Text="Add New" CssClass="btnHelp" Width="90px"
                                                ValidationGroup="save" OnClick="btnAdd_Click" Height="24px" />&nbsp;<asp:Button ID="btnSave"
                                                    runat="server" Text="Save" CssClass="btnHelp" Width="90px" OnClientClick="return Vasuli();"
                                                    ValidationGroup="add" OnClick="btnSave_Click" Height="24px" TabIndex="42" />
                                            &nbsp;
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <asp:TextBox ID="txtMillEmailID" runat="server" CssClass="txt" Width="200px" AutoPostBack="True"
                                    OnTextChanged="txtMillEmailID_TextChanged" TabIndex="5" Height="24px"></asp:TextBox>
