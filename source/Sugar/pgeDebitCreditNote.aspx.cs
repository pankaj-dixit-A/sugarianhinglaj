...
public partial class pgeDebitCreditNote : System.Web.UI.Page
{
                      ...
                      //  hdnfMill.Value = dt.Rows[0]["mc"].ToString();
                        ...
                        if (drpSub_Type.SelectedValue == "CN" || drpSub_Type.SelectedValue == "DN")
                        {
                            qty = clsDAL.GetString(" select Qty from qrySaleBillForDebitnote where Tran_Type='" + hdnfBilltype.Value
                               + "' and Billid=" + hdnfbillid.Value + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + "");
                        }
                        else
                        {
    ...
    protected void btnAdddetails_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dr["ExAcodeId"] = clsCommon.getString("select isnull(Ac_Code,0) as id from NT_1_qryAccountsList where Ac_Code=" + txtAc_CodeDetails.Text + " and company_code=" + Session["company_code"].ToString() + "");
            // dr["AutoIDetailId"] = lblExAcId.Text;
            dr["ic"] = clsCommon.getString("select system_code from NT_1_SystemMaster where  System_Type='I' and system_code=" + txtItem_Code.Text + " and company_code=" + Session["company_code"].ToString() + "");
            if (btnAdddetails.Text == "ADD")
            {
                dr["AutoIDetailId"] = 0;
                dt.Rows.Add(dr);
        ...
        try
        {
            ...
            if (strTextBox == "txtAc_Code")
            {
                ...
                if (txtAc_Code.Text != string.Empty)
                {
                    ...
                    {
                     //   hdnfAccode.Value = clsCommon.getString("select accoid from NT_1_qryAccountsList where Ac_Code=" + txtAc_Code.Text + " and Company_Code=" + Session["Company_Code"].ToString() + "");
                        acname = clsCommon.getString("select Ac_Name_E from  NT_1_qryAccountsList where Ac_Code=" + txtAc_Code.Text
                                + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
            ...
            if (strTextBox == "txtAc_CodeDetails")
            {
                ...
                if (txtAc_CodeDetails.Text != string.Empty)
                {
                    ...
                    else
                    {
                        ...
                        acname = clsCommon.getString("select Ac_Name_E from  NT_1_qryAccountsList where Ac_Code=" + txtAc_CodeDetails.Text
                                + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
            ...
            if (strTextBox == "txtShipTo")
            {
                ...
                if (txtShipTo.Text != string.Empty)
                {
                    ...
                    {
                    //    hdnfShipTo.Value = clsCommon.getString("select accoid from NT_1_qryAccountsList where Ac_Code=" + txtShipTo.Text + " and Company_Code=" + Session["Company_Code"].ToString() + "");
                        acname = clsCommon.getString("select Ac_Name_E from  NT_1_qryAccountsList where Ac_Code=" + txtShipTo.Text
                                + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
            ...
            if (strTextBox == "txtMill_Code")
            {
                ...
                if (txtMill_Code.Text != string.Empty)
                {
                    ...
                    {
                       // hdnfMill.Value = clsCommon.getString("select accoid from NT_1_qryAccountsList where Ac_Code=" + txtMill_Code.Text + " and Company_Code=" + Session["Company_Code"].ToString() + "");
                        acname = clsCommon.getString("select Ac_Name_E from  NT_1_qryAccountsList where Ac_Code=" + txtMill_Code.Text
                                + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
            ...
            if (strTextBox == "txtUnit")
            {
                ...
                if (txtUnit.Text != string.Empty)
                {
                    ...
                    {
                      //  hdnfUnit.Value = clsCommon.getString("select accoid from NT_1_qryAccountsList where Ac_Code=" + txtUnit.Text + " and Company_Code=" + Session["Company_Code"].ToString() + "");
                        acname = clsCommon.getString("select Ac_Name_E from  NT_1_qryAccountsList where Ac_Code=" + txtUnit.Text
                                + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
            ...
            if (txtAc_Code.Text.Trim() != string.Empty)
            {
                ...
                if (a == true)
                {
                    //AcStateCode = clsCommon.getString("select isnull(GSTStateCode,0) from  NT_1_qryAccountsList where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Ac_Code=" + txtAc_Code.Text + "");
                    AcStateCode = clsCommon.getString("select isnull(GSTStateCode,0) from  NT_1_qryAccountsList where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Ac_Code=" + txtShipTo.Text + "");
        ...
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtBillNo")
            {
                ...
                if (drpSub_Type.SelectedValue == "CN" || drpSub_Type.SelectedValue == "DN")
                {
                    ...
                    qry = " select distinct Billid,doc_no,docdate,Ac_Code,Ac_Name_E as Party_Name,Amount,Tran_Type,ShipTo,ShipToName,MillCode,MillName,Bill_To,'' as BillToName,'' as uc,'' as mc,'' as bt,Qty,Year_Code as BillYC from qrySaleBillForDebitnote" +
                         " where  Ac_Code=" + txtAc_Code.Text + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                        + " and " + name + " and Year_Code="+Session["year"].ToString()+" order by docdate desc";
                }
                else
                {
                    ...
                    qry = " select distinct purchaseid,doc_no,docdate,Ac_Code,Ac_Name_E as Party_Name,TCS_Net_Payable as Amount,Tran_Type,ShipTo,ShipToName,mill_code,MillName,0 as Bill_To,'' as BillToName,'' as uc,'' as mc,0 as bt,Qty,Year_Code as BillYC from qrypurchasebillforDebitnote" +
                         " where  Ac_Code=" + txtAc_Code.Text + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                        + " and " + name + " and Year_Code=" + Session["year"].ToString() + " order by docdate desc";
                }
            ...
            if (hdnfClosePopup.Value == "txtAc_Code")
            {
                ...
                lblPopupHead.Text = "--Select Branch Code--";
                qry = "select Ac_Code,Ac_Name_E,cityname from  NT_1_qryAccountsList   where  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
            ...
            if (hdnfClosePopup.Value == "txtAc_CodeDetails")
            {
                ...
                string qry = "select Ac_Code,Ac_Name_E,cityname from  NT_1_qryAccountsList   where  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
               + "  and ( " + name + ") order by Ac_Name_E";
                this.showPopup(qry);
