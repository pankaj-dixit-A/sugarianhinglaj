...
public partial class Sugar_Master_PgeDebitCreditNoteUtility : System.Web.UI.Page
{
    ...
    {
        qryCommon = "qrydebitnotehead";
        cs = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        con = new SqlConnection(cs);
        if (!IsPostBack)
        {
            strval = Request.QueryString["tran_type"];
            if (strval != null)
            {
                drpTrnType.SelectedValue = strval;
            }
            BindDummyRow();
        }
        SetFocus(btnAdd);
    ...
    private void BindDummyRow()
    {
        ...
        dummy.Columns.Add("dcid");
        dummy.Columns.Add("ShopTo_Name");
        dummy.Columns.Add("bill_id");
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Ac_Name_E like '%" + aa + "%' or doc_no like '%" + aa + "%' or tran_type like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or bill_amount like '%" + aa + "%' or dcid like '%" + aa + "%' or ShopTo_Name like '%" + aa + "%' or bill_id like '%" + aa + "%' or ackno like '%" + aa + "%') and";
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid,ShopTo_Name,bill_id,ackno FROM qrydebitnotehead    where " + name + " and tran_type='" + Trantype + "' and Company_Code=" + Company_Code + " " +
    ...
    {
        string RecordCount = "";
        string cs1 = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
    ...
    protected void gvCustomers_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //{
        //    cell.Attributes.Add("title", "Tooltip text " + cell.Text);
        //}
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid,ShopTo_Name,bill_id,ackno FROM " + qryCommon + " limit 15";
