<%@ Page Title="Balance Sheet Group" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="pgeBSgroupMaster.aspx.cs" Inherits="Sugar_pgeBSgroupMaster" %>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 60%;" align="center" cellpadding="4" cellspacing="4">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtgroupCode" runat="Server" CssClass="txt" TabIndex="2" Width="80px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtgroupName" runat="Server" CssClass="txt" TabIndex="3" Width="250px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="drpGroupSummary" runat="server" CssClass="ddl" Width="100px"
                                TabIndex="4" Height="24px" OnSelectedIndexChanged="drpGroupSummary_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="drpgroupSection" runat="server" CssClass="ddl" Width="200px"
                                TabIndex="5" Height="24px" OnSelectedIndexChanged="drpgroupSection_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtGroupOrder" runat="Server" CssClass="txt" TabIndex="6" Width="100px"
                                Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtGroupOrder_TextChanged"
                                Height="24px"></asp:TextBox>
