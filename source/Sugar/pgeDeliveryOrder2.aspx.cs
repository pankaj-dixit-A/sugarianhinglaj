...
public partial class pgeDeliveryOrder2 : System.Web.UI.Page
{
    #region data section
    string temp = "0";
                                ...
                                if (drpDOType.SelectedValue == "DI")
                                {
                                    if (txtGETPASS_CODE.Text == selfac || PDS == "P")
                                    {
                                        ...
                                        if (PDS == "P")
                                        {
                                            ...
                                            obj.columnNm = "doc_no,item_code,Tran_Type,Quantal,packing,bags,rate,item_Amount,Company_Code,Year_Code,Branch_Code,Created_By";
                                            obj.values = "'" + saleNumber + "','1','SB','" + QUANTAL + "','" + PACKING + "','" + BAGS + "','" + SALE_RATE + "','" + (QUANTAL * SALE_RATE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + Convert.ToInt32(Session["Branch_Code"].ToString()) + "','" + user + "'";
                                            ds = new DataSet();
                                            ds = obj.insertAccountMaster(ref strRev);
                                        ...
                                        //code to delete purchase on client demand
                                        string updateddatetime = "08-12-2016";
                                        string nowDatetime = DateTime.Now.ToString("dd-MM-yyyy");
                                        if (nowDatetime != updateddatetime)
                                        {
                                            string deletePurchase = "delete from " + tblPrefix + "SugarPurchase where DOC_NO=" + purchaseNo + " and Tran_Type='PS'  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                            clsDAL.SimpleQuery(deletePurchase);

                                            string deletePurchaseDetails = "delete from " + tblPrefix + "SugarPurchaseDetails where doc_no=" + purchaseNo + " and Tran_Type='PS'  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                            clsDAL.SimpleQuery(deletePurchaseDetails);

                                            string deleteLedgerEffect = "delete from " + tblPrefix + "GLEDGER where DOC_NO=" + purchaseNo + " and TRAN_TYPE='PS' and COMPANY_CODE=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and YEAR_CODE=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                            clsDAL.SimpleQuery(deleteLedgerEffect);

                                            qry = "";
                                            qry = "update " + tblHead + " set voucher_no='" + 0 + "' where company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and tran_type='DO' and doc_no=" + DOC_NO;
                                ...
                                if (drpDOType.SelectedValue == "DO")
                                {
                                    if (DIFF_AMOUNT != 0)
                                    {
                                        ...
                                        if (LVVoucherAmount > 0)
                                        {
                                            ...
                                            obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                            ds = obj.insertAccountMaster(ref strRev);
                                            ...
                                            obj.tableName = GLedgerTable;
                                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                            obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                            ds = obj.insertAccountMaster(ref strRev);
                                        }
                                        else
                                        {
                                            ...
                                            obj.tableName = GLedgerTable;
                                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                            obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                            ds = obj.insertAccountMaster(ref strRev);
                                            ...
                                            obj.tableName = GLedgerTable;
                                            obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                            obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                            ds = obj.insertAccountMaster(ref strRev);
                                        }
                                        ...
                                        if (MEMO_ADVANCE != 0)
                                        {
                                            if (drpCC.SelectedValue == "Credit")
                                            {
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + TRANSPORT_CODE + "','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                            }
                                            else
                                            {
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + LVNumber + "','" + DOC_DATE + "','1','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                ...
                                if (drpDOType.SelectedValue == "DI")
                                {
                                    if (txtGETPASS_CODE.Text == selfac || PDS == "P")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (DONumber != 0)
                                            {
                                                ...
                                                if (nowDatetime != updateddatetime)
                                                {
                                                    string deletePurchase = "delete from " + tblPrefix + "SugarPurchase where DOC_NO=" + voucher_no + " and Tran_Type='PS'  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                                    clsDAL.SimpleQuery(deletePurchase);

                                                    string deletePurchaseDetails = "delete from " + tblPrefix + "SugarPurchaseDetails where doc_no=" + voucher_no + " and Tran_Type='PS'  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                                    clsDAL.SimpleQuery(deletePurchaseDetails);

                                                    string deleteLedgerEffect = "delete from " + tblPrefix + "GLEDGER where DOC_NO=" + voucher_no + " and TRAN_TYPE='PS' and COMPANY_CODE=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and YEAR_CODE=" + Convert.ToInt32(Session["year"].ToString()) + "";
                                                    clsDAL.SimpleQuery(deleteLedgerEffect);
                                            ...
                                            if (PDS == "P")
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (drpDeliveryType.SelectedValue == "C")
                                                    {
                                                        obj.columnNm = "PURCNO='" + PN + "',DOC_DATE='" + DOC_DATE + "',AC_CODE='" + saleParty + "',Unit_Code='" + pdsunit + "',MILL_CODE='" + MILL_CODE + "',FROM_STATION='" + From_Place + "',TO_STATION='" + unitcity + "',LORRYNO='" + TRUCK_NO + "',BROKER='" + BROKER_CODE + "',SUBTOTAL='" + (QUANTAL * SALE_RATE) + "',LESS_FRT_RATE='" + FRIEGHT_RATE + "',FREIGHT='" + FRIEGHT_AMOUNT + "',BILL_AMOUNT='" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE) + "',NETQNTL='" + QUANTAL + "',Modified_By='" + user + "',DO_No='" + DOC_NO + "',Transport_Code='" + SaleBillTransport + "',CASH_ADVANCE='" + MEMO_ADVANCE + "' where Tran_Type='SB' and Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code='" + Convert.ToInt32(Session["year"].ToString()) + "' and DOC_NO=" + DONumber + "";
                                                    }
                                                    else
                                                    {
                                                        obj.columnNm = "PURCNO='" + PN + "',DOC_DATE='" + DOC_DATE + "',AC_CODE='" + saleParty + "',Unit_Code='" + pdsunit + "',MILL_CODE='" + MILL_CODE + "',FROM_STATION='" + From_Place + "',TO_STATION='" + unitcity + "',LORRYNO='" + TRUCK_NO + "',BROKER='" + BROKER_CODE + "',SUBTOTAL='" + (QUANTAL * SALE_RATE) + "',LESS_FRT_RATE='" + FRIEGHT_RATE + "',FREIGHT='" + FRIEGHT_AMOUNT + "',BILL_AMOUNT='" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE - FRIEGHT_AMOUNT) + "',NETQNTL='" + QUANTAL + "',Modified_By='" + user + "',DO_No='" + DOC_NO + "',Transport_Code='" + SaleBillTransport + "',CASH_ADVANCE='" + MEMO_ADVANCE + "' where Tran_Type='SB' and Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code='" + Convert.ToInt32(Session["year"].ToString()) + "' and DOC_NO=" + DONumber + "";
                                                    }
                                                    obj.values = "none";
                                                    ds = obj.insertAccountMaster(ref strRev);
                                            ...
                                            else
                                            {
                                                if (!string.IsNullOrEmpty(txtSaleBillTo.Text))
                                                {
                                                    if (lblSB_No.Text == string.Empty)
                                                    {
                                                        ...
                                                        if (drpDeliveryType.SelectedValue == "C")
                                                        {
                                                            obj.values = "'" + saleNumber + "','SB','" + purcNo + "','" + DOC_DATE + "','" + salebillto + "','" + salebillto + "','" + MILL_CODE + "','" + From_Place + "','" + salebilltocity + "','" + TRUCK_NO + "','" + BROKER_CODE + "','" + (QUANTAL * SALE_RATE) + "','" + FRIEGHT_RATE + "','" + FRIEGHT_AMOUNT + "','" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE) + "','" + QUANTAL + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + Convert.ToInt32(Session["Branch_Code"].ToString()) + "','" + user + "','" + DOC_NO + "','" + SaleBillTransport + "','" + MEMO_ADVANCE + "'";
                                                        }
                                                        else
                                                        {
                                                            obj.values = "'" + saleNumber + "','SB','" + purcNo + "','" + DOC_DATE + "','" + salebillto + "','" + salebillto + "','" + MILL_CODE + "','" + From_Place + "','" + salebilltocity + "','" + TRUCK_NO + "','" + BROKER_CODE + "','" + (QUANTAL * SALE_RATE) + "','" + FRIEGHT_RATE + "','" + FRIEGHT_AMOUNT + "','" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE - FRIEGHT_AMOUNT) + "','" + QUANTAL + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + Convert.ToInt32(Session["Branch_Code"].ToString()) + "','" + user + "','" + DOC_NO + "','" + SaleBillTransport + "','" + MEMO_ADVANCE + "'";
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (!string.IsNullOrEmpty(Convert.ToString(salebillnumber)))
                                                        {
                                                            if (salebillnumber != 0)
                                                            {
                                                                ...
                                                                if (drpDeliveryType.SelectedValue == "C")
                                                                {
                                                                    obj.columnNm = "PURCNO='" + PN + "',DOC_DATE='" + DOC_DATE + "',AC_CODE='" + salebillto + "',Unit_Code='" + salebillto + "',MILL_CODE='" + MILL_CODE + "',FROM_STATION='" + From_Place + "',TO_STATION='" + salebilltocity + "',LORRYNO='" + TRUCK_NO + "',BROKER='" + BROKER_CODE + "',SUBTOTAL='" + (QUANTAL * SALE_RATE) + "',LESS_FRT_RATE='" + FRIEGHT_RATE + "',FREIGHT='" + FRIEGHT_AMOUNT + "',BILL_AMOUNT='" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE) + "',NETQNTL='" + QUANTAL + "',Modified_By='" + user + "',DO_No='" + DOC_NO + "',Transport_Code='" + SaleBillTransport + "',CASH_ADVANCE='" + MEMO_ADVANCE + "' where Tran_Type='SB' and Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code='" + Convert.ToInt32(Session["year"].ToString()) + "' and DOC_NO=" + salebillnumber + "";
                                                                }
                                                                else
                                                                {
                                                                    obj.columnNm = "PURCNO='" + PN + "',DOC_DATE='" + DOC_DATE + "',AC_CODE='" + salebillto + "',Unit_Code='" + salebillto + "',MILL_CODE='" + MILL_CODE + "',FROM_STATION='" + From_Place + "',TO_STATION='" + salebilltocity + "',LORRYNO='" + TRUCK_NO + "',BROKER='" + BROKER_CODE + "',SUBTOTAL='" + (QUANTAL * SALE_RATE) + "',LESS_FRT_RATE='" + FRIEGHT_RATE + "',FREIGHT='" + FRIEGHT_AMOUNT + "',BILL_AMOUNT='" + ((QUANTAL * SALE_RATE) + MEMO_ADVANCE - FRIEGHT_AMOUNT) + "',NETQNTL='" + QUANTAL + "',Modified_By='" + user + "',DO_No='" + DOC_NO + "',Transport_Code='" + SaleBillTransport + "',CASH_ADVANCE='" + MEMO_ADVANCE + "' where Tran_Type='SB' and Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code='" + Convert.ToInt32(Session["year"].ToString()) + "' and DOC_NO=" + salebillnumber + "";
                                                                ...
                                                                obj.flag = 2;
                                                                obj.tableName = tblPrefix + "sugarsaleDetails";
                                                                obj.columnNm = "item_code='1',Quantal='" + QUANTAL + "',packing='" + PACKING + "',bags='" + BAGS + "',rate='" + SALE_RATE + "',item_Amount='" + (QUANTAL * SALE_RATE) + "',Modified_By='" + user + "' where Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code='" + Convert.ToInt32(Session["year"].ToString()) + "'  and doc_no=" + salebillnumber + "";
                                                                obj.values = "none";
                                                                ds = new DataSet();
                                                                ds = obj.insertAccountMaster(ref strRev);
                                                                gleder.SugarSaleGledgerEffect("SB", DONumber, Convert.ToInt32(Session["Company_Code"].ToString()), Convert.ToInt32(Session["year"].ToString()));
                                    ...
                                    else
                                    {
                                        ...
                                        else if (lblVoucherType.Text == "OV")
                                        {
                                            ...
                                            else if (DONumber == 0 && lblVoucherType.Text == "OV")
                                            {
                                                MaxVoucher();
                                                if (hdnvouchernumber.Value != string.Empty)
                                                {
                                    ...
                                    if (drpDOType.SelectedValue == "DO")
                                    {
                                        ...
                                        if (DONumber != 0)
                                        {
                                            ...
                                            if (LVVoucherAmount > 0)
                                            {
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "','LV','" + voucher_no + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + voucher_no + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                            }
                                            else
                                            {
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + DONumber + "','" + Branch_Code + "','LV','" + voucher_no + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                                ...
                                                obj.tableName = GLedgerTable;
                                                obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + int.Parse(Session["QUALITY_DIFF_AC"].ToString()) + "','" + GETPASS_CODE + "','" + vouchnarration + "','" + Math.Abs(LVVoucherAmount) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + DONumber + "','" + Branch_Code + "','LV','" + voucher_no + "'";
                                                ds = obj.insertAccountMaster(ref strRev);
                                            }
                                            ...
                                            if (MEMO_ADVANCE != 0)
                                            {
                                                if (drpCC.SelectedValue == "Credit")
                                                {
                                                    ...
                                                    obj.tableName = GLedgerTable;
                                                    obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                    obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + TRANSPORT_CODE + "','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                    ds = obj.insertAccountMaster(ref strRev);
                                                    ...
                                                    obj.tableName = GLedgerTable;
                                                    obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                    obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','" + VOUCHER_BY + "','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "D" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                    ds = obj.insertAccountMaster(ref strRev);
                                                }
                                                else
                                                {
                                                    ...
                                                    obj.tableName = GLedgerTable;
                                                    obj.columnNm = "TRAN_TYPE,DOC_NO,DOC_DATE,AC_CODE,UNIT_Code,NARRATION,AMOUNT,COMPANY_CODE,YEAR_CODE,ORDER_CODE,DRCR,ADJUSTED_AMOUNT,Branch_Code,SORT_TYPE,SORT_NO";
                                                    obj.values = "'LV','" + DONumber + "','" + DOC_DATE + "','1','" + 0 + "','" + vouchnarration + "','" + Math.Abs(MEMO_ADVANCE) + "','" + Convert.ToInt32(Session["Company_Code"].ToString()) + "','" + Convert.ToInt32(Session["year"].ToString()) + "','" + GID + "','" + "C" + "','" + 0 + "','" + Branch_Code + "','LV','" + DONumber + "'";
                                                    ds = obj.insertAccountMaster(ref strRev);
                                ...
                                for (int i = 0; i < grdDetail.Rows.Count; i++)
                                {
                                    ...
                                    if (grdDetail.Rows[i].Cells[9].Text != "N" && grdDetail.Rows[i].Cells[9].Text != "R")
                                    {
                                        ...
                                        if (grdDetail.Rows[i].Cells[9].Text == "U")
                                        {
                                            obj.flag = 2;
                                            obj.tableName = tblDetails;
                                            obj.columnNm = " ddType= '" + ddType + "',doc_no='" + DOC_NO + "',Bank_Code='" + Bank_Code + "',Narration='" + Narration + "',Amount='" + Amount + "',UTR_NO='" + Utr_no + "'" +
    ...
    private void calculation()
    {
        try
        {
            ...
            lblDiffrate.Text = Math.Round(diff, 2).ToString();
    ...
    protected void txtMemoAdvanceRate_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            double frtRate = Convert.ToDouble(txtFrieght.Text.ToString());
