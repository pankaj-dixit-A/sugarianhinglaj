...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function EInovice() {
            ...
            window.open('../Sugar/pgeEInovice.aspx?dono=' + dono + '&Type=RB&ID=' + ID, "_self");
        }
        function Confirm() {
    ...
    <script type="text/javascript">
        ...
        function SBPen(DO) {
            var Action = 1;
            window.open('../Sugar/pgeServiceBill.aspx?rbid=' + DO + '&Action=' + Action, "_self");
        }
    </script>
    <script type="text/javascript">
        ...
        function ProcessXML(XML, status, spname) {
            ...
            $.ajax({
                type: "POST",
                url: "../Sugar/xmlExecuteDMLQry.asmx/ExecuteXMLQry",
            ...
            function OnSuccess(response) {
                ...
                if (status != "Delete") {
                    if (response.d.length > 0) {
                        ...
                        window.open('../Sugar/pgeServiceBill.aspx?rbid=' + id + '&Action=1', "_self");
