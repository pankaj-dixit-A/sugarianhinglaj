<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispSummary.aspx.cs" Inherits="Report_rptDispSummary" %>
                                                ...
                                                <ItemTemplate>
                                                    <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 1%" align="center">
                                                                <asp:LinkButton Style="text-decoration: none;" runat="server" ID="lnkOV" Text='<%#Eval("VO") %>'
                                                                    OnClick="lnkOV_Click"></asp:LinkButton>
                                                            </td>
                                                            <td style="width: 1%" align="center">
                                                                <asp:LinkButton Style="text-decoration: none;" runat="server" ID="lnkMM" Text='<%#Eval("MM") %>'
