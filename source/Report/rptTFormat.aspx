<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTFormat.aspx.cs" Inherits="Report_rptTFormat" %>
                            ...
                            <ItemTemplate>
                                <table width="100%" cellspacing="2">
                                    <tr>
                                        ...
                                        <td align="center" style="width: 30%;">
                                            <asp:Label ID="lblACBalance" runat="server" Text='<%#Eval("Balace") %>' Font-Size="12px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
