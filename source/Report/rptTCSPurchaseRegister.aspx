<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTCSPurchaseRegister.aspx.cs"
    Inherits="Report_rptTCSPurchaseRegister" Title="rpt:TCS Purchase Register" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="100%" Text="TSC Purchase Report" CssClass="lblName"
            ...
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="border-bottom: 1px solid black;
                ...
                <tr>
                    ...
                    <td align="right" style="width: 4%;">
                        <asp:Label ID="Label1" runat="server" Text="Bill Amount" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="right" style="width: 3%;">
                        <asp:Label ID="Label2" runat="server" Text="TCS Amount" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
            </table>
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="border-bottom: 1px solid black;
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" align="center" cellpadding="3" cellspacing="0" style="border-bottom: 1px dashed black;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="width: 3%;">
                                                                <asp:Label ID="lbldtlTCSAmount" runat="server" Text='<%#Eval("TCS_Amt")%>' Font-Bold="true"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
                                        ...
                                        <td style="width: 100%;" colspan="8">
                                            <table width="100%" align="center" cellpadding="3" cellspacing="0" style="border-bottom: 1px solid  black;
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 3%;">
                                                        <asp:Label ID="lbldtlDetailsTCSAmount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <td style="width: 100%;">
                        <table width="100%" align="center" cellpadding="3" cellspacing="0" style="border-bottom: 1px solid  black;
                            ...
                            <tr>
                                ...
                                <td align="right" style="width: 3%;">
                                    <asp:Label ID="lblGrandTCSAmount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
