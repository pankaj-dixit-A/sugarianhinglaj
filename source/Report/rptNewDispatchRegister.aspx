<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptNewDispatchRegister.aspx.cs"
        ...
        <asp:Panel runat="server" ID="pnlMain">
            ...
            <table width="90%" style="table-layout: fixed;" align="center" class="print2">
                <tr>
                    ...
                    <td align="left" style="width: 15%; border-bottom: 1px solid black; border-top: 1px solid black;">
                        Mill
                    </td>
                    <td align="left" style="width: 8%; border-bottom: 1px solid black; border-top: 1px solid black;">
                        Rate
                    </td>
                    <td align="center" style="width: 7%; border-bottom: 1px solid black; border-top: 1px solid black;">
                        Quantal
                    </td>
                    <td align="left" style="width: 20%; border-bottom: 1px solid black; border-top: 1px solid black;">
                        Name of Party
                    </td>
                                        ...
                                        <td style="width: 100%;">
                                            <table width="100%" align="center" style="table-layout: fixed;" cellspacing="1" class="print2">
                                                <tr style="border-bottom: 1px solid black;">
                                                    ...
                                                    <td align="center" style="width: 15%; background-color: #FFFFCC; font-size: large;
                                                                    ...
                                                                    <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                                        <ItemTemplate>
                                                                            <table width="100%" style="table-layout: fixed;" align="center" cellspacing="2" class="print2">
                                                                                <tr>
                                                                                    <td align="left" style="width: 3%;">
                                                                                        <asp:Label runat="server" ID="lblDoNo" Font-Bold="true" Text='<%#Eval("#") %>'></asp:Label>
                                                                                    </td>
                                                                                    ...
                                                                                    <td colspan="10">
                                                                                        <table width="100%" align="center" cellspacing="2" class="print2" style="table-layout: fixed;">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="right" style="width: 3%;" class="noprint">
                                                                                                </td>
                                                                                                <td align="right" style="width: 2%;" class="noprint">
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="10">
                                                                                        <table width="100%" align="center" style="table-layout: fixed;" cellspacing="2" class="print2">
                                                                                            <tr>
                                                                                                <td style="width: 1%; border-left: 2px double black;" align="center">
                                                                                                    <asp:Label runat="server" ID="lblPurcNo" Text='<%#Eval("tn") %>'></asp:Label>
                                                                                                </td>
                                                                                                <td style="width: 1%; border-right: 2px double black;" align="center">
                                                                                                ...
                                                                                                <td style="width: 3%; border-bottom: 1px solid black;" align="center">
                                                                                                    <asp:Label runat="server" ID="lblVoucNo" Text='<%#Eval("VN") %>'></asp:Label>
                                                                                                </td>
                                                                                                <td style="width: 2%;" align="right">
                                                                                                    <asp:Label runat="server" ID="Label15" Text="Final:"></asp:Label>
                                                                                                </td>
                                                                                                <td style="width: 5%; border-bottom: 1px solid black;" align="center">
                                                                                        ...
                                                                                        <table width="100%" align="center" style="border-bottom: 1px dashed black; table-layout: fixed;"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="width: 100%;" align="left">
                                                                                                    <asp:Label runat="server" ID="lblGetpass" Text='<%#Eval("getpass") %>' Font-Bold="false"></asp:Label>&nbsp;&nbsp;<asp:Label
                                                                                                        runat="server" ID="Label17" Text='<%#Eval("PaymentTo") %>' Font-Bold="false"></asp:Label>&nbsp;&nbsp;<asp:Label
                                                                                                            runat="server" ID="Label16" Text='<%#Eval("narr4") %>' Font-Bold="false"></asp:Label>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
