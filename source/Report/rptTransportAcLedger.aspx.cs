    ...
    private void bindData()
    {
        try
        {
            if (Branch_Code == string.Empty)
            {
                ...
                {
                    qry = "select distinct(transport) as TransportCode,TransportName from " + tblPrefix + "qryDeliveryOrderListReport where tran_type='DO' and transport!=0 and doc_date between '" + fromDt + "' and '" + toDt + "' and company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and voucher_by=" + Transport_Ac + " order by TransportName";
                }
            ...
            else
            {
                ...
                {
                    qry = "select distinct(transport) as TransportCode,TransportName from " + tblPrefix + "qryDeliveryOrderListReport where tran_type='DO' and transport!=0 and doc_date between '" + fromDt + "' and '" + toDt + "' and company_code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and Branch_Code=" + Branch_Code + " and voucher_by=" + Transport_Ac + " order by TransportName";
                }
