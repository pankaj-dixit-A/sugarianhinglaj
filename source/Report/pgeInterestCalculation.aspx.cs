    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                {
                    string acname = clsCommon.getString("select [Ac_Name_E] from " + AccountMasterTable + " where [Ac_Code]=" + txtAc_Code.Text + " and [Company_Code]=" + Convert.ToInt32(Session["Company_Code"].ToString()));
        ...
        try
        {
            if (txtAc_Code.Text != string.Empty)
            {
                ...
                else
                {
                    ...
                    {
                        lblAC_Code.Text = str;
                        txtEmailID.Text = clsCommon.getString("select Email_Id from " + tblPrefix + "AccountMaster where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Ac_Code=" + txtAc_Code.Text);
                        setFocusControl(txtFromDt);
                        pnlPopup.Style["display"] = "none";
                    }
                    else
