...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function BSS(fromDT, toDT, Branch_Code) {
            window.open('../Report/rptBalanceStockSummary.aspx?fromDT=' + fromDT + '&toDT=' + toDT + '&Branch_Code=' + Branch_Code);
        }
    </script>
    <script type="text/javascript" language="javascript">
                                    ...
                                    <asp:TemplateField HeaderText="Driver Mobile">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="TextBox1" BorderStyle="None" Text='<%#Eval("DriverMobile") %>'
                                                Height="20px" Width="85px" MaxLength="10"></asp:TextBox></ItemTemplate>
                                    </asp:TemplateField>
