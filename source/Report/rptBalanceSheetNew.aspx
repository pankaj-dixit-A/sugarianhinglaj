<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBalanceSheetNew.aspx.cs"
    Inherits="Report_rptBalanceSheetNew" %>
    ...
    <div>
        ...
        <div>
            <asp:Panel ID="PrintPanel" runat="server" align="center" Font-Names="Calibri" CssClass="largsize">
                <asp:Label ID="lblReportName" runat="server" Text="Balance Sheet" Width="100%" CssClass="lblName"
                                            ...
                                            <td align="left" style="width: 70%;">
                                                <asp:Label ID="lblGroupCodeL" runat="server" Text='<%#Eval("Group_Code") %>' Font-Bold="true"
                                                    Visible="false" Font-Size="11px"></asp:Label><asp:Label ID="lblGroupNameR" runat="server"
                                                        Text='<%#Eval("groupname") %>' Font-Bold="true" Font-Size="14px"></asp:Label>&nbsp;<asp:Label
                                                            ID="lblsummaryL" runat="server" Font-Size="16px" Text='<%#Eval("summary") %>'
