<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBrokerWiseShortDetailAll.aspx.cs"
    Inherits="Report_rptBrokerWiseShortDetailAll" %>
                                            ...
                                            <asp:DataList runat="server" ID="dtlDetails" Width="100%" OnItemDataBound="dtlDetails_OnItemDataBound">
                                                <ItemTemplate>
                                                    ...
                                                    <%--   <table width="100%" align="center" cellpadding="1" cellspacing="2" style="table-layout: fixed;
                                                        border-bottom: 1px dashed black; background-color: #FFFFFF;">
                                                        <tr>
                                                            <td style="width: 10%;" align="center">
                                                                <asp:Label runat="server" ID="lbl1" Text="Tran_No" Font-Bold="true"></asp:Label>
                                                            </td>
                                                            <td style="width: 10%;" align="center">
                                                                <asp:Label runat="server" ID="Label2" Text="Tran_Type" Font-Bold="true"></asp:Label>
                                                            </td>
                                                            <td style="width: 10%;" align="center">
                                                                <asp:Label runat="server" ID="Label3" Text="Tran_Date" Font-Bold="true"></asp:Label>
                                                            </td>
                                                            <td style="width: 40%;" align="left">
                                                                <asp:Label runat="server" ID="Label4" Text="Narration" Font-Bold="true"></asp:Label>
                                                            </td>
                                                            <td style="width: 30%;" align="center">
                                                                <asp:Label runat="server" ID="Label5" Text="Paid Amount" Font-Bold="true"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>--%>
