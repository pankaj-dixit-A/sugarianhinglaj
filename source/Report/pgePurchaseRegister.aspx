<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgePurchaseRegister.aspx.cs" Inherits="Report_pgePurchaseRegister" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function pr(Ac_Code, FromDt, ToDt) {
            window.open('rptDateWisePurchaseRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }

        function sr(Ac_Code, FromDt, ToDt) {
            window.open('rptDateWiseSaleRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        function tcspr(Ac_Code, FromDt, ToDt) {
            window.open('rptTCSPurchaseRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        function tcssale(Ac_Code, FromDt, ToDt) {
            window.open('rptTCSSaleRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        function tdspr(Ac_Code, FromDt, ToDt) {
            window.open('rptTDSPurchaseRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        function tdssale(Ac_Code, FromDt, ToDt) {
            window.open('rptTDSSaleRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
    </script>
        ...
        <tr>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnPurchaseReport" CssClass="btnHelp" Text="Purchase Report"
                    OnClick="btnPurchaseReport_Click" Width="180px" Height="24px" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnSaleReport" CssClass="btnHelp" Text="Sale Report"
                    Width="120px" Height="24px" OnClick="btnSaleReport_Click" />
            </td>
        </tr>
        <tr>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnTCSPurchaseReport" CssClass="btnHelp" Text="TCS Purchase Report"
                    OnClick="btnTCSPurchaseReport_Click" Width="180px" Height="24px" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnTCSSaleReport" CssClass="btnHelp" Text="TCS Sale Report"
                    OnClick="btnTCSSaleReport_Click" Width="120px" Height="24px" />
            </td>
        </tr>
        <tr>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnTDSPurchaseReport" CssClass="btnHelp" Text="TDS Purchase Report"
                    OnClick="btnTDSPurchaseReport_Click" Width="180px" Height="24px" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnTDSSaleReport" CssClass="btnHelp" Text="TDS Sale Report"
                    OnClick="btnTDSSaleReport_Click" Width="120px" Height="24px" />
            </td>
        </tr>
    </table>
