<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCarporateBalance.aspx.cs"
                        ...
                        <asp:DataList runat="server" ID="dtlist" Width="100%" OnItemDataBound="dtlist_ItemDataBound">
                            <ItemTemplate>
                                <table width="100%" align="center">
                                    <tr>
                                        <td style="width: 100%" align="center">
                                            <table id="Table4" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                    ...
                                    <tr>
                                        <td style="width: 100%" align="left">
                                            <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                <ItemTemplate>
                                                    <table runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                                        border-bottom: 1px solid black; background-color: #CCFFFF;">
                                                        <tr>
                                                            <td style="width: 2%" align="center">
                                    ...
                                    <tr>
                                        <td style="width: 100%;">
                                            <table id="Table3" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
