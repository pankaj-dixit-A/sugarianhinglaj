<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProfitLoss.aspx.cs" Inherits="Report_rptProfitLoss"
    ...
    <div>
        ...
        <div>
            <asp:Panel ID="PrintPanel" runat="server" align="center" Font-Names="Calibri">
                <asp:Label ID="lblReportName" runat="server" Text="Profit & Loss" Width="100%" CssClass="lblName"
