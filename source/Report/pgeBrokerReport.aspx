...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="60%" align="center">
        ...
        <tr>
            ...
            <td align="left" colspan="2" style="width: 60%;">
                <asp:TextBox ID="txtPartyCode" runat="server" Width="80px" CssClass="txt" AutoPostBack="True"
                    Height="24px" OnTextChanged="txtPartyCode_TextChanged"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:Button runat="server" ID="btnBrokerDetail" CssClass="btnHelp" OnCommand="Command_Click"
                    Height="24px" CommandName="BD" Text="Broker Detail" Width="185px" />
                &nbsp;&nbsp;<asp:Button runat="server" ID="btnBrokerWiseShortNew" Text="Broker Wise Short Payment"
                    CssClass="btnHelp" OnCommand="Command_Click" CommandName="BWSP" Width="185px"
                    Height="24px" />
                &nbsp;&nbsp;<asp:Button runat="server" ID="btnBrokerWiseLatePayment" CssClass="btnHelp"
                    Height="24px" OnCommand="Command_Click" CommandName="BWLP" Text="Broker Wise Late Payment"
                    Width="185px" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button runat="server" ID="btnAllBrokerDetail" CssClass="btnHelp" OnCommand="Command_Click"
                    Height="24px" CommandName="ABD" Text="All Broker Detail" Width="185px" />&nbsp;&nbsp;&nbsp;<asp:Button
                        runat="server" ID="btnBrokerWiseShortPayAll" CssClass="btnHelp" Text="Broker Wise ShortPay All"
                ...
                &nbsp;&nbsp;<asp:Button runat="server" ID="btnBrokerWiseLatePayAll" CssClass="btnHelp"
                    Height="24px" OnCommand="Command_Click" CommandName="BWLPA" Text="Broker Wise Late Pay All"
                    Width="185px" />
            </td>
        </tr>
        <tr>
