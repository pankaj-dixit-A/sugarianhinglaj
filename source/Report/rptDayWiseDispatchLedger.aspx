<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDayWiseDispatchLedger.aspx.cs"
    Inherits="Report_rptDayWiseDispatchLedger" %>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="print3">
            ...
            <table id="Table1" runat="server" width="95%" align="center" cellspacing="2" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td style="width: 1%" align="center">
                        <asp:Label runat="server" ID="Label12" Font-Bold="true" Text="OV"></asp:Label>
                    </td>
                    <td style="width: 1%" align="center">
                        <asp:Label runat="server" ID="Label13" Font-Bold="true" Text="MM"></asp:Label>
                    </td>
                </tr>
            </table>
                                            ...
                                            <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                <ItemTemplate>
                                                    <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                                        ...
                                                        <tr>
                                                            <td style="width: 1%" align="center">
                                                                <asp:Label runat="server" ID="lblDate" Font-Bold="false" Text='<%#Eval("no") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 2%" align="left">
