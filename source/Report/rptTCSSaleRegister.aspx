<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTCSSaleRegister.aspx.cs"
    Inherits="Report_rptTCSSaleRegister" Title="rpt:TCS Sale Register" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="100%" Text="TSC Sale Report" CssClass="lblName"
