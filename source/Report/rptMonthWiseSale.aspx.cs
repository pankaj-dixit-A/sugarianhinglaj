...
public partial class Report_rptMonthWiseSale : System.Web.UI.Page
{
    ...
    {
        qry = "select DATEPART(yyyy,doc_date) as yea,DATEPART(MM,doc_date) as mon,NETQNTL as quantal,Bill_Amount as amount from " + tblPrefix + "SugarSale" +
