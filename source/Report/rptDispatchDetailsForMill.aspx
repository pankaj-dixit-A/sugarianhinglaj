<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispatchDetailsForMill.aspx.cs"
    Inherits="Report_rptDispatchDetailsForMill" %>
                            ...
                            <ItemTemplate>
                                <table width="100%" align="center" cellpadding="2" cellspacing="0" style="table-layout: fixed;
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width: 6%;">
                                            <asp:Label ID="lblTenderDO" runat="server" Visible="true" Text='<%# Eval("Tender_DO") %>'
                                                Font-Bold="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
