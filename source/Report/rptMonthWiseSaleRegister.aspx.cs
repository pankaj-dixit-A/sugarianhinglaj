...
public partial class Report_rptMonthWiseSaleRegister : System.Web.UI.Page
{
    ...
    {
        qry = "select DATEPART(yyyy,doc_date) as yea,DATEPART(MM,doc_date) as mon,SUM(NETQNTL) as quantal,SUM(Bill_Amount) as amount from " + tblPrefix + "SugarSale" +
