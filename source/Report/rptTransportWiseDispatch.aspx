<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTransportWiseDispatch.aspx.cs"
    Inherits="Report_rptTransportWiseDispatch" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Transportwise Dispatch</title>
                                ...
                                <table width="100%" align="center">
                                    <tr>
                                        <td style="width: 70%;" align="left">
                                            <asp:Label runat="server" ID="lblMillName" Font-Bold="true" Text='<%#Eval("TransportName") %>'></asp:Label>
                                        </td>
                                        <td style="width: 30%;" align="left">
                                            <asp:Label runat="server" ID="lblMillCode" Text='<%#Eval("TransportCode") %>' Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" align="center" cellpadding="1" cellspacing="0">
