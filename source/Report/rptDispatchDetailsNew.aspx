<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispatchDetailsNew.aspx.cs"
    Inherits="Report_rptDispatchDetailsNew" %>
                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <asp:DataList runat="server" ID="dtlDispatch" Width="100%">
                                                <ItemTemplate>
                                                    <table width="100%" align="center" cellpadding="1" cellspacing="2" style="background-color: #00FFFF">
                                                        <tr>
