...
public partial class Reports_rptLedger : System.Web.UI.Page
{
    ...
    protected void lnkGo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //var dt11 = "01/07/2017";
            //var dt1 = DateTime.Parse(dt11);
            //var dtt = grdDetail.Rows[rowIndex].Cells[2].Text;
            ...
            //DateTime dt1 = DateTime.Parse(Convert.ToDateTime("01/07/2017").ToShortDateString());
            //DateTime dt = DateTime.Parse(Convert.ToDateTime(grdDetail.Rows[rowIndex].Cells[2].Text).ToShortDateString());
            ...
            if (No != "0")
            {
                ...
                else
                {
                    ...
                    var manDate = DateTime.ParseExact(dtt, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
                    DateTime dt = Convert.ToDateTime(manDate);

                    var expDate = DateTime.ParseExact(grdDetail.Rows[rowIndex].Cells[2].Text, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
                    DateTime dt1 = Convert.ToDateTime(expDate);
