<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptWithPaymentDifference.aspx.cs"
    Inherits="Report_rptWithPaymentDifference" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri">
            <asp:Label ID="lblReportName" runat="server" Text="Partywise With Payment Difference"
            ...
            <table id="Table2" runat="server" align="center" width="90%" class="largsize">
                <tr>
