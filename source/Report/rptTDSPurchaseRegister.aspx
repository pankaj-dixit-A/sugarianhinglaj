<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTDSPurchaseRegister.aspx.cs"
    Inherits="Report_rptTDSPurchaseRegister" Title="rpt:TDS Purchase Register" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="100%" Text="TDS Purchase Report" CssClass="lblName"
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" align="center" cellpadding="3" cellspacing="0" style="border-bottom: 1px dashed black;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="width: 3%;">
                                                                <asp:Label ID="lbldtlTCSAmount" runat="server" Text='<%#Eval("TDS_Amt")%>' Font-Bold="true"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
