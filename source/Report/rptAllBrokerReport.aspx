<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAllBrokerReport.aspx.cs"
    ...
    <div>
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <table width="40%" align="center" cellpadding="1" cellspacing="0">
                ...
                <tr>
                    <td colspan="2" align="right" style="border-bottom: double 2px black;">
                    </td>
                </tr>
                <tr>
            ...
            <table width="40%" align="center" cellpadding="2" cellspacing="0">
                <tr>
                    <td>
