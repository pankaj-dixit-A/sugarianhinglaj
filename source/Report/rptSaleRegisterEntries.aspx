<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleRegisterEntries.aspx.cs"
    Inherits="Report_rptSaleRegisterEntries" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri" CssClass="print">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="90%" Text="Sale Register Summary" CssClass="lblName"
            ...
            <table width="80%" align="center" cellpadding="1" cellspacing="0" class="print">
                <tr>
                    <td align="right" style="border-bottom: solid 2px black;">
                    </td>
                </tr>
                <tr>
                        ...
                        <asp:DataList ID="dtl" runat="server" Width="100%" OnItemDataBound="DataList_ItemDataBound"
                            ...
                            <ItemTemplate>
                                <table align="center" width="100%" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                                    border-bottom: dashed 2px black; background-color: #CCFFFF;" class="print">
                                    <tr>
                                        <td align="center" style="width: 2%;">
                                        ...
                                        <td align="left" style="width: 3%;">
                                            <asp:Label ID="lblFrom" runat="server" Text='<%#Eval("from_station") %>' Font-Bold="false"></asp:Label>
                                        </td>
                                        <td align="left" style="width: 3%;">
                                            <asp:Label ID="lblTo" runat="server" Text='<%#Eval("to_station") %>' Font-Bold="false"></asp:Label>
                                        </td>
                                        <td align="center" style="width: 3%;">
                                        ...
                                        <td align="left" style="width: 6%;" class="smallfont">
            ...
            <table align="center" width="80%" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                background-color: #FFFFCC; border-bottom: 1px solid black; border-top: 1px solid black;"
                class="print">
                <tr>
                    <td align="center" style="width: 2%;">
