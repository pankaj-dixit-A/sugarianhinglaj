<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptWithPaymentDiff.aspx.cs"
    Inherits="Report_rptWithPaymentDiff" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Resale Diff To Pay</title>
...
<body>
    ...
    <div>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri">
            <asp:Label ID="lblReportName" runat="server" Text="Detail With Payment Difference"
            ...
            <table id="Table3" runat="server" align="center" width="80%" class="largsize">
                ...
                <tr>
                    <td align="center" style="width: 100%">
                        <asp:Label runat="server" ID="lblPartyCode" Text="Diff To Pay Report" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 100%">
                        <table id="Table4" runat="server" width="100%" align="left" style="table-layout: fixed;"
                            ...
                            <tr>
                                ...
                                <td style="width: 2%; background-color: #FFFFCC;" align="center">
                                    <asp:Label runat="server" ID="lblDiffAmount" Font-Bold="true" Text="amount"></asp:Label>
                                </td>
                                <td style="width: 2%; background-color: #FFFFCC;" align="center">
                            ...
                            <ItemTemplate>
                                <table id="Table1" runat="server" width="100%" align="left" style="table-layout: fixed;"
                                    ...
                                    <tr style="background-color: #CCFFFF;">
                                        ...
                                        <td style="width: 2%" align="center">
                                            <asp:Label runat="server" ID="Label18" Font-Bold="false" Text='<%#Eval("finalAmt") %>'></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="border-bottom: 1px dashed black;">
                                        ...
                                        <td style="width: 4%; border-bottom: 1px double black;" align="center">
