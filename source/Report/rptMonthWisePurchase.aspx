<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMonthWisePurchase.aspx.cs"
    Inherits="Report_rptMonthWisePurchase" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <table runat="server" align="center" width="40%" style="table-layout: fixed;">
                <tr>
            ...
            <table id="Table1" runat="server" align="center" width="40%">
                <tr>
                    <td align="right" style="border-bottom: double 2px black;">
                    </td>
                </tr>
            ...
            <table id="Table2" runat="server" align="center" width="40%" style="table-layout: fixed;
