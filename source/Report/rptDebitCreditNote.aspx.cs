...
public partial class Foundman_Master_rptDebitCreditNote : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
          ...
          //  string monumber = Session["Company_Phone"].ToString();
            ...
            rprt1.Load(Server.MapPath("CryDebitCrditnotenew.rpt"));
            rprt1.DataDefinition.FormulaFields["companystate"].Text = "\"" + companystate + "\"";
            // rprt1.DataDefinition.FormulaFields["gst"].Text = "\"" + GSTNO + "\"";
            //   rprt1.DataDefinition.FormulaFields["monumber"].Text = "\"" + monumber + "\"";
            rprt1.DataDefinition.FormulaFields["inword"].Text = "\"" + inWords + "\"";
            ...
            //  rprt1.DataDefinition.FormulaFields["Address"].Text = "\"" + Address1 + "\"";
            ...
            cryDebitCreditNote.ReportSource = rprt1;

            cryDebitCreditNote.RefreshReport();
    ...
    private DataTable GetData(int bill_no, string type, int year_code, int company_code)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from qrydebitnoteheaddetail where tran_type='" + type + "' and Doc_No=" + billno + " and Year_Code=" + year_code + " and Company_Code=" + company_code, con);
    ...
    //            System.IO.Directory.CreateDirectory("C:\\PDFFiles");
    //        }
    //        string filename = filepath + "\\DebitCreditNote" + billno + "_" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    //        rprt1.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, filename);
    ...
    //            msg.To.Add(mail);
    //            //msg.Body = "DebitCreditNote";

    //            msg.Body = "Dear Sir / Madam <br /> With reference to above Subject please refer the attached Dr. Cr. Note , Please confirm it.,  <br /> we are uploading in coming GSTR-1 Return.<br/><br/><b>Thanks & Regards</b> <br/> " +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryDebitCreditNote.ReportSource = null;

        cryDebitCreditNote.Dispose();
