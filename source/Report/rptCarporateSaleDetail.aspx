<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCarporateSaleDetail.aspx.cs"
    Inherits="Report_rptCarporateSaleDetail" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            <table id="Table2" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed">
                ...
                <tr>
                    <td style="width: 100%; border-bottom: 1px double black;">
                    </td>
                </tr>
            </table>
            ...
            <table runat="server" width="90%" align="center" cellspacing="2">
                <tr>
                    <td style="width: 100%; border-bottom: 1px double black;">
                    </td>
                </tr>
                            ...
                            <ItemTemplate>
                                ...
                                <table id="Table3" runat="server" width="100%" style="table-layout: fixed;">
                                    <tr>
                                        ...
                                        <td style="width: 2%" align="center">
                                            <asp:Label runat="server" ID="Label14" Font-Bold="false" Text="Frt"></asp:Label>
                                        </td>
                                        <td style="width: 2%" align="center">
                                            <asp:Label runat="server" ID="Label15" Font-Bold="false" Text="Transport"></asp:Label>
                                        </td>
                                        <td style="width: 4%" align="center">
                                            <asp:Label runat="server" ID="Label16" Font-Bold="false" Text="Mobile"></asp:Label>
                                        </td>
                                        ...
                                        <td style="width: 2%" align="left">
                                            <asp:Label runat="server" ID="Label18" Font-Bold="false" Text="OV"></asp:Label>
                                        </td>
                                        <td style="width: 2%" align="left">
                                ...
                                <table id="Table4" runat="server" width="100%">
                                    ...
                                    <tr>
                                        <td style="width: 100%;" align="left">
                                            <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                <ItemTemplate>
                                                    <table id="Table3" runat="server" width="100%" style="table-layout: fixed; background-color: #FFFFCC;
                                                        border-bottom: 1px dashed black;">
                                                        <tr>
                                                            <td style="width: 1%" align="center">
                                                                <asp:Label runat="server" ID="Label8" Font-Bold="false" Text='<%#Eval("DONo") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 2%" align="center">
                                                            ...
                                                            <td style="width: 2%" align="center">
                                                                <asp:Label runat="server" ID="Label14" Font-Bold="false" Text='<%#Eval("DOFrt") %>'></asp:Label>
                                                            </td>
                                                            ...
                                                            <td style="width: 4%" align="center">
                                                                <asp:Label runat="server" ID="Label16" Font-Bold="false" Text='<%#Eval("DOMobile") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 6%" align="left">
                                                            ...
                                                            <td style="width: 2%" align="left">
                                                                <asp:LinkButton runat="server" ID="lnkMM" Text='<%#Eval("MM") %>' OnClick="lnkMM_Click"></asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="width: 100%; height: 15px; border-top: 1px double black;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%; border-bottom: 1px double black;">
