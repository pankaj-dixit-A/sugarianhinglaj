<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSugarBalanceStocks.aspx.cs"
    Inherits="Reports_rptSugarBalanceStocks" %>
                            ...
                            <ItemTemplate>
                                <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="width: 7%;">
                                            <asp:Label ID="Label12" runat="server" Text='<%#Eval("Lifting_Date") %>' Font-Bold="true"></asp:Label>
                                        </td>
                                        <td align="right" style="width: 8%;">
