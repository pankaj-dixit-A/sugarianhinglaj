<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBrokerWiseShortPayNew.aspx.cs"
    Inherits="Report_rptBrokerWiseShortPayNew" %>
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" align="center" cellpadding="1" cellspacing="3" style="table-layout: fixed;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" style="width: 3%;">
                                                                <asp:Label ID="Label2" runat="server" Text='<%#Eval("ASN") %>' Font-Bold="false"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
