<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptVasuliRegister.aspx.cs"
    Inherits="Report_rptVasuliRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Vasuli Register</title>
...
<body>
    ...
    <div>
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="90%" Text="Vasuli Register" CssClass="lblName"
                ...
                <tr>
                    <td style="width: 100%" align="left">
                        <asp:DataList runat="server" Width="100%" ID="dtl" OnItemDataBound="DataList_OnItemDataBound">
                            <ItemTemplate>
                                <table align="left" width="100%" cellpadding="1" style="border-bottom: 1px solid black;">
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100%;">
                                            <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                <ItemTemplate>
                                                    <table align="left" width="100%" cellpadding="5" style="table-layout: fixed; background-color: #FFFFCC;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="width: 3%;">
                                                                <asp:Label ID="lbldtAmount" runat="server" Text='<%#Eval("vasuli_amount") %>' Font-Bold="false"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
