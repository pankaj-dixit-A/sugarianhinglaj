<%@ Page Title="Bank Book" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeBankBook.aspx.cs" Inherits="Report_pgeBankBook" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        function sp(accode, fromdt, todt) {
            var tn;
            window.open('rptBankBook.aspx?accode=' + accode + '&fromdt=' + fromdt + '&todt=' + todt, '_blank');
        }
    </script>
    <script type="text/javascript" language="javascript">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
        ...
        <legend style="text-align: center;">
            <asp:Label ID="label1" runat="server" Text="   Bank Book   " Font-Names="verdana"
    ...
    <table width="50%" cellspacing="5" align="center">
        ...
        <tr>
            <td align="center" colspan="4">
                    <asp:Button runat="server" ID="btnShow" Text="SHOW" CssClass="btnHelp" Width="80px"
                        Height="24px" onclick="btnShow_Click" />
            </td>
        </tr>
    </table>
