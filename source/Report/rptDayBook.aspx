<%@ Page Title="rpt:Day Book" Language="C#" AutoEventWireup="true" CodeFile="rptDayBook.aspx.cs"
    Inherits="Report_rptDayBook" %>
    ...
    <div>
        <asp:Panel ID="PrintPanel" runat="server" align="center" Font-Names="Calibri">
            <table width="1000px" align="center">
                ...
                <tr>
                    <td align="center" colspan="2">
                     <asp:Label ID="lblfromdate" Width="100%" runat="server" Text="" Style="text-align: center;"
