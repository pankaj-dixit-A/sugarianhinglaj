...
public partial class Report_rptTDSSaleRegister : System.Web.UI.Page
{
    ...
    protected void dtl_OnItemDataBound(object sender, DataListItemEventArgs e)
    {
        try
        {
            ...
            qry = "select doc_no,Convert(varchar(10),doc_date,103) as doc_date,subTotal,TDS_Amt from NT_1_qryTCSSaleReport where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code="
            ...
            if (ds != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        lblDate1.Text = "TDS Sale Register From :" + fromDT + " To " + toDT;
