<%@ Page Title="rpt:Trial Balance" Language="C#" AutoEventWireup="true" CodeFile="rptTrialBalance.aspx.cs"
    Inherits="Reports_rptTrialBalance" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="90%" Text="Trial Balance" CssClass="lblName"
                    ...
                    <ItemTemplate>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td align="right" style="width: 10%;">
                                    <asp:Label ID="lblDebitTotal" runat="server" Text="d" Font-Bold="true" Visible="false"></asp:Label>
                                </td>
                                <td align="right" style="width: 10%;">
                                    <asp:Label ID="lblCreditTotal" runat="server" Text="c" Font-Bold="true" Visible="false"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
