            ...
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                ...
                <tr>
                    <td align="left" style="width: 2%;">
                        <asp:Label ID="lblNo" runat="server" Text="No." Font-Bold="true" ForeColor="White"></asp:Label>
                    </td>
                    ...
                    <td align="center" style="width: 4%;">
                        <asp:Label ID="lblNetQntl" runat="server" Text="Net Qntl" Font-Bold="true" ForeColor="White"></asp:Label>
                    </td>
                    <td align="left" style="width: 2%;">
                        <asp:Label ID="Label1" runat="server" Text="" Font-Bold="true" ForeColor="White"></asp:Label>
                    </td>
                    <td align="left" style="width: 5%;">
                        <asp:Label ID="lblMillRate" runat="server" Text="Mill Rt" Font-Bold="true" ForeColor="White"></asp:Label>
                    </td>
                    <td align="left" style="width: 4%;">
