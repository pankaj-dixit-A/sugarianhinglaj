...
<body oncontextmenu="return false">
    ...
    <div style="background-color: rgb(243, 248, 247);">
        <table width="72%" align="center" style="background-color: White; margin-top: 130px;
            border: 1px solid rgb(230, 219, 219); height: 100%;">
            <tr>
                <td style="width: 100%; height: 90%;">
                    <table align="center" width="90%" cellpadding="2px" cellspacing="10px">
                        <tr>
                            <td colspan="2" align="left" style="width: 100%; background-color: #000000; color: White;
                                ...
                                Welcome Shri Hinglaj Enterprises
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="width: 80%;" align="left">
                                <asp:Panel ID="pnlLeft" runat="server" Width="100%" Height="365px" BorderStyle="Solid"
                                    BorderColor="GradientActiveCaption" BackImageUrl="~/Images/hingjal.jpg" BorderWidth="1px">
                                </asp:Panel>
                            </td>
